...
范围：`专家团工作台 UX、状态保护与企业放行门禁实施计划` Tasks 1–2。本文只审计稳定 view/presenter 与最小可见状态，不提前宣称 Task 3–7 已完成。
