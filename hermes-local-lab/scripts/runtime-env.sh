...
AGENT_DIR="${TAIJI_AGENT_AGENT_DIR:-$LAB_DIR/sources/hermes-agent}"
WEBUI_DIR="${TAIJI_AGENT_WEBUI_DIR:-$LAB_DIR/sources/hermes-webui}"
...
if [ "${TAIJI_AGENT_USE_USER_DIRS:-0}" = "1" ]; then
  ...
  HERMES_HOME="${HERMES_HOME:-$TAIJI_DATA_DIR/hermes-home}"
  HERMES_WORKSPACE="${HERMES_WORKSPACE:-$TAIJI_DATA_DIR/workspace}"
