...
test('TemplatePackage contract requires plan-level manifest metadata', () => {
  const templatePackage = {
    ...
    files: {
      ...
      adapterSample: 'adapter-sample.render-plan.json',
    },
    manifest: {
      id: 'general-proposal',
...
test('DeliveryPackage contract requires the complete editable delivery bundle', () => {
  const deliveryPackage = {
    ...
    fileSha256: {
      ...
      source: 'b'.repeat(64),
      sourcePackage: '4'.repeat(64),
      originalSource: 'c'.repeat(64),
      assetPackage: '3'.repeat(64),
      jobManifest: 'd'.repeat(64),
      templateManifest: 'e'.repeat(64),
      renderPlan: 'f'.repeat(64),
      qualityReport: '1'.repeat(64),
      imageInstructions: '2'.repeat(64),
    },
    files: {
