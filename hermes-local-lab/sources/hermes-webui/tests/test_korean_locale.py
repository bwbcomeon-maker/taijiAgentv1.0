...
def test_korean_locale_includes_representative_translations():
    ...
    expected = [
        ...
        "onboarding_title: 'taiji Agent에 오신 것을 환영합니다'",
    ]
...
def test_korean_settings_detail_descriptions_are_translated():
    ...
    expected = [
        ...
        "settings_desc_sync_insights: 'WebUI 토큰 사용량을 state.db에 반영하여 taiji Agent /insights에 브라우저 세션 데이터가 포함되도록 합니다. 기본값은 꺼짐입니다.'",
