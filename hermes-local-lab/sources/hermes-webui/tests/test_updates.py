...
def test_dirty_suffix_includes_local_change_stamp(tmp_path):
    """Dirty dev versions need a changing cache-bust token after local edits."""
    changed = tmp_path / "static" / "panels.js"
    ...
    changed.write_text("two-two", encoding="utf-8")
