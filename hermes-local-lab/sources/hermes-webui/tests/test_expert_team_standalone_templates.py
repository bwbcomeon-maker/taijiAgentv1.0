...
def test_standalone_launch_profiles_use_local_docx_templates():
    ...
    assert profiles["content-meeting-minutes"]["render_template_id"] == "standalone-meeting-minutes"
    assert profiles["content-notice"]["render_template_id"] == "standalone-office-material"
    assert profiles["content-plan"]["render_template_id"] == "standalone-office-material"
    assert profiles["content-summary-plan"]["render_template_id"] == "standalone-office-material"
    assert profiles["content-polish"]["render_template_id"] == "standalone-office-material"
