...
const LOCALES = {
  en: {
    ...
    offline_network_detail: 'taiji Agent is unreachable from this browser right now.',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_desc_sync_insights: 'Mirrors WebUI token usage to state.db so taiji Agent /insights includes browser session data. Off by default.',
  ...
  zh: {
    ...
    offline_network_detail: '此浏览器当前无法连接到 taiji Agent。',
    offline_autorefresh: '当 taiji Agent 可访问时，我会自动刷新此页面。',
    ...
    mcp_security_notice: 'Filesystem MCP 只能访问授权目录；文件写入、删除、覆盖以及浏览器表单提交等操作需要二次确认。',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    settings_desc_sync_insights: '将 WebUI token 使用情况同步到 state.db，使 taiji Agent /insights 包含浏览器会话数据。默认关闭。',
    ...
    settings_desc_voice_mode: '在听写麦克风旁显示语音模式按钮（音频波形）。让您自然说话 — taiji Agent 会在停顿后自动发送并朗读回复。需要支持语音识别和 TTS 的浏览器。',
