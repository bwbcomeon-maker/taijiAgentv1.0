...
const LOCALES = {
  en: {
    ...
    offline_browser_detail: 'This device appears to be offline.',
    offline_network_detail: 'taiji Agent is unavailable right now.',
    offline_autorefresh: 'I will refresh this page automatically when taiji Agent is reachable again.',
    ...
    mic_denied: 'Microphone access denied. Check system permissions.',
    mic_no_speech: 'No speech detected. Try again.',
    mic_network: 'Speech recognition unavailable.',
    mic_unavailable: 'Microphone input is unavailable.',
    ...
    voice_error: 'Voice input is not supported here',
    ...
    mcp_servers_desc: 'View configured MCP servers.',
    ...
    mcp_restart_hint: 'Server changes update local agent configuration. Reload MCP tools or restart the app for a fresh runtime inventory.',
    mcp_config_title: 'MCP Configuration',
    mcp_config_name: 'Name',
    mcp_config_preset: 'Preset',
    mcp_config_custom: 'Custom stdio',
    mcp_config_command: 'Command',
    mcp_config_args: 'Arguments',
    mcp_config_allowed_roots: 'Authorized directories',
    mcp_paste_path: 'Paste path',
    mcp_choose_directory: 'Choose directory',
    mcp_path_pasted: 'Path pasted.',
    mcp_path_empty_clipboard: 'Clipboard has no path text.',
    mcp_clipboard_unavailable: 'Cannot read clipboard. Use Cmd/Ctrl+V or right-click paste.',
    mcp_directory_selected: 'Directory selected.',
    mcp_directory_picker_unavailable: 'Directory picker is available in the desktop app. Paste an absolute path here.',
    mcp_directory_picker_failed: 'Failed to choose directory.',
    mcp_save_config: 'Save MCP config',
    mcp_test_connection: 'Test connection',
    mcp_testing_connection: 'Testing MCP connection…',
    mcp_test_success: (count) => `Connected. ${count} tools found.`,
    mcp_test_failed: 'MCP connection test failed.',
    mcp_security_notice: 'Only authorized directories are available to Filesystem MCP. File writes, deletes, overwrites, and browser form submissions require confirmation.',
    mcp_call_logs_title: 'MCP Tool Call Logs',
    mcp_call_logs_desc: 'Recent MCP tool calls with redacted arguments.',
    mcp_logs_empty: 'No MCP tool-call logs yet.',
    mcp_logs_failed: 'Failed to load MCP tool-call logs.',
    mcp_log_ok: 'OK',
    mcp_log_error: 'Error',
    ...
    mcp_tools_summary_none: '没有可显示的 MCP 工具。',
    ...
    mcp_tools_page_size_suffix: '项',
    mcp_tools_per_page_aria: '每页 MCP 工具数量',
    ...
    // approval card
    approval_heading: 'Confirm an operation',
    approval_desc_prefix: 'Dangerous command detected',
    approval_summary_generic: 'taiji Agent needs to perform a protected operation to continue this task.',
    approval_summary_pipe_interpreter: 'taiji Agent needs to run a local script to continue this task.',
    approval_summary_capability: 'taiji Agent needs to enable a local capability to continue this task.',
    approval_summary_delete_files: 'taiji Agent needs to delete local files to continue this task.',
    approval_summary_reset_changes: 'taiji Agent needs to discard local changes to continue this task.',
    approval_summary_overwrite_config: 'taiji Agent needs to modify a local configuration file to continue this task.',
    approval_summary_elevated_permission: 'taiji Agent needs elevated system permission to continue this task.',
    approval_summary_shortened_url: 'taiji Agent needs to open a shortened link whose destination is hidden.',
    approval_summary_homograph_url: 'taiji Agent detected a web address that may imitate a trusted site.',
    approval_permission_label: 'Permission needed',
    approval_permission_local_command: 'Run a command on this device',
    approval_impact_label: 'After allowing',
    approval_impact_continue_task: 'This step runs and the current task continues.',
    approval_impact_capability: 'This capability becomes available for the selected scope.',
    approval_risk_generic: 'Safety note: only allow this if it matches the task you requested.',
    approval_risk_pipe_interpreter: 'Safety note: content may be passed directly to a program. Only allow if you trust its source.',
    approval_risk_capability: 'Safety note: later high-risk operations will still ask for confirmation.',
    approval_view_details: 'View details',
    approval_details_note: 'Technical information for troubleshooting:',
    approval_details_empty: 'No additional technical information.',
    approval_rule_label: 'Security rule',
    approval_more_options: 'More authorization options',
    approval_confirm_always: 'This will remember the same type of operation for future tasks. Confirm only on a trusted device.',
    approval_confirm_skip_all: 'New protected operations in this conversation will no longer ask first. The current and already queued operations still require your decision. This increases risk.',
    approval_impact_delete_files: 'The selected local files will be removed.',
    approval_risk_delete_files: 'Deleted content may be difficult to recover.',
    approval_impact_reset_changes: 'Uncommitted local changes will be discarded.',
    approval_risk_reset_changes: 'Unsaved work may be lost.',
    approval_impact_overwrite_config: 'A local configuration file will be changed.',
    approval_risk_overwrite_config: 'The related application may behave differently afterward.',
    approval_impact_elevated_permission: 'The operation will run with additional system privileges.',
    approval_risk_elevated_permission: 'It can affect system settings or other users.',
    approval_impact_shortened_url: 'The link may redirect to another website.',
    approval_risk_shortened_url: 'The real destination is hidden. Continue only if you trust the link source.',
    approval_impact_homograph_url: 'A website with a look-alike address may be opened.',
    approval_risk_homograph_url: 'It may be a phishing site. Check the address carefully before allowing.',
    approval_submit_failed: 'The request was not submitted. Please try again.',
    approval_escape_hint: 'Press Esc to choose Do not allow',
    approval_confirm_cancel: 'Go back',
    approval_confirm_continue: 'Confirm',
    approval_pending_count: (n) => `Item 1 of ${n} waiting for confirmation`,
    approval_notification_title: 'Action needs your confirmation',
    approval_btn_once: 'Allow this step only',
    approval_btn_once_title: 'Allow only the current step',
    approval_btn_session: 'Allow in this conversation',
    approval_btn_session_title: 'Allow the same operation during this conversation',
    approval_btn_always: 'Always allow similar operations',
    approval_btn_always_title: 'Remember and allow this type of operation in the future',
    approval_btn_deny: 'Not now',
    approval_btn_deny_title: 'Do not allow this operation',
    ...
    provider_mismatch_warning: (m,p) => `"${m}" may not work with your configured provider (${p}). Send anyway, or switch providers in Settings.`,
    provider_mismatch_label: 'Provider mismatch',
    gateway_auth_label: '本地对话服务认证失败',
    ...
    model_search_clear_title: 'Clear search',
    model_use_custom_title: 'Use this model',
    ...
    cmd_skills: 'List available taiji Agent skills',
    cmd_writeflow: '运行写作工作流',
    writeflow_busy: '写作工作流正在执行。',
    writeflow_compose_failed: '写作工作流失败：',
  ...
  status_agent_running:'Agent running',
    ...
    status_hermes_home: 'taiji Agent home',
  ...
  untitled:'Untitled',
    ...
    session_title_regenerate_desc: 'Ask taiji Agent to generate a fresh title from the conversation',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    session_project_filter_all: 'All',
    session_project_filter_unassigned: 'Unassigned',
    session_project_filter_unassigned_title: 'Show conversations not yet assigned to a project',
    session_project_filter_empty_unassigned: 'No unassigned conversations.',
    session_project_filter_empty_project: 'No conversations in this project yet.',
    ...
    settings_section_preferences_meta: 'Defaults and UI behavior for taiji Agent.',
    ...
    settings_plugins_meta: 'View installed taiji Agent plugins and the lifecycle hooks they register. This panel is read-only.',
    settings_plugins_empty: 'No taiji Agent plugins are currently visible. Install or enable plugins from administrator configuration to see them here.',
    ...
    kanban_work_queue_hint: 'This is the taiji Agent work queue. Create or triage a task, assign it, move it to Ready, then let the dispatcher claim it.',
    ...
    kanban_assignee_profiles_label: 'taiji Agent profiles',
    ...
    tab_dashboard: 'taiji Agent Dashboard',
    dashboard_loopback_warning: 'Dashboard is unavailable from this entry. Use the desktop app or contact an administrator.',
    tab_logs: 'Logs',
    ...
    insights_skill_usage_footer: 'Counts from local skill data.',
    ...
    settings_desc_voice_mode: 'Show the voice-mode button (audio waveform) next to the dictation mic. Lets you speak naturally — taiji Agent auto-sends after a pause and reads replies aloud. Requires a browser that supports both speech recognition and TTS.',
    ...
    settings_desc_sync_insights: 'Mirrors token usage to state.db so taiji Agent /insights includes local session data. Off by default.',
    settings_desc_check_updates: 'Show a banner when newer versions of taiji Agent are available. Runs a background update check periodically.',
    ...
    password_env_var_locked: 'A system-level password override (HERMES_WEBUI_PASSWORD) is active. Remove HERMES_WEBUI_PASSWORD and restart the app before managing the password here.',
    password_env_var_locked_placeholder: 'Locked: HERMES_WEBUI_PASSWORD is active',
    disable_auth: 'Disable Auth',
    sign_out: 'Sign Out',
    settings_label_shutdown: 'Stop the taiji Agent server',
    settings_desc_shutdown: 'Gracefully stops the current taiji Agent application runtime. Relaunch the desktop app before using it again.',
    settings_btn_shutdown: 'Stop server',
    settings_shutdown_confirm_title: 'Stop taiji Agent',
    settings_shutdown_confirm_message: 'Stop the taiji Agent server?',
    settings_shutdown_confirm_btn: 'Stop',
    settings_shutdown_stopped_message: 'Application runtime stopped. You can close this window.',
    // Providers panel
    ...
    providers_oauth_config_yaml_hint: 'Token configured by administrator settings. Use administrator configuration to update it.',
    providers_oauth_not_configured_hint: 'Not authenticated. Complete administrator authentication to configure this provider.',
    providers_save: 'Save',
    ...
    provider_endpoint_label: 'Actual model request address',
    provider_endpoint_source_label: 'Address source',
    provider_endpoint_status_label: 'Address status',
    provider_endpoint_source_system: 'System',
    provider_endpoint_source_managed: 'Administrator',
    provider_endpoint_source_custom: 'Custom',
    provider_endpoint_source_runtime: 'Runtime',
    provider_endpoint_source_unknown: 'Unknown',
    provider_endpoint_status_resolved: 'Resolved',
    provider_endpoint_status_runtime_managed: 'Runtime assigned',
    provider_endpoint_status_runtime_unresolved: 'Resolved at request time',
    provider_endpoint_status_missing: 'Not configured',
    provider_endpoint_status_invalid_saved_value: 'Legacy address ignored; enter a new one',
    provider_endpoint_status_unknown: 'Unknown',
    provider_endpoint_override_ignored: 'Legacy address override is ignored; save to clean it up.',
    provider_endpoint_mutation_cleaned: 'Legacy address override cleaned up.',
    provider_endpoint_saved_label: 'Address used after saving',
    provider_endpoint_admin_readonly: 'Managed by administrator settings; editing is unavailable here.',
    provider_endpoint_base_url_required: 'Enter a valid Custom Base URL.',
    ...
    cancel: 'Cancel',
    create_job: 'Create scheduled task',
    ...
    onboarding_title: 'Welcome to taiji Agent',
    onboarding_lead: 'A quick guided setup checks the local app, saves provider credentials, chooses a workspace and model, and optionally protects the app with a password.',
    onboarding_back: 'Back',
    onboarding_continue: 'Continue',
    onboarding_skip: 'Skip setup',
    onboarding_resume: 'Continue setup checks',
    onboarding_skipped: 'Setup skipped — using existing config.',
    onboarding_open: 'Open taiji Agent',
    onboarding_step_system_title: 'System check',
    onboarding_step_system_desc: 'Check local app readiness.',
    onboarding_step_setup_title: 'Provider setup',
    onboarding_step_setup_desc: 'Save provider credentials.',
    ...
    onboarding_step_password_desc: 'Protect the app before sharing it.',
    onboarding_step_finish_title: 'Finish',
    onboarding_step_finish_desc: 'Review and enter the app.',
    onboarding_notice_system_ready: 'The local app is ready.',
    onboarding_notice_system_unavailable: 'The local app is still preparing. Finish setup after readiness checks pass.',
    onboarding_check_agent: 'Local app',
    onboarding_check_agent_ready: 'Ready',
    onboarding_check_agent_missing: 'Still preparing',
    ...
    onboarding_check_provider: 'Provider',
    ...
    onboarding_config_status: 'Configuration:',
    onboarding_config_status_ready: 'Local configuration is ready',
    onboarding_config_status_pending: 'Waiting for setup',
    onboarding_credentials_status: 'Credentials:',
    onboarding_credentials_status_saved: 'Local credentials are saved',
    onboarding_credentials_status_pending: 'No provider credentials saved yet',
    onboarding_provider_status: 'Provider status:',
    onboarding_unknown: 'Unknown',
    onboarding_current_provider: 'Current setup:',
    onboarding_missing_imports: 'Missing imports:',
    onboarding_notice_setup_required: '请在此选择模型提供商并保存凭据。',
    onboarding_notice_setup_already_ready: 'A working provider setup is already detected. You can keep it or replace it here.',
    onboarding_oauth_provider_ready_title: 'Provider already authenticated',
    onboarding_oauth_provider_ready_body: '当前应用已配置为使用 OAuth 提供商（<strong>{provider}</strong>）。这里不需要 API key，点击继续即可完成设置。',
    onboarding_oauth_provider_not_ready_title: 'OAuth provider not yet authenticated',
    onboarding_oauth_provider_not_ready_body: '当前应用已配置为使用 <strong>{provider}</strong>，该提供商使用 OAuth 而非 API key。请完成管理员认证后重新加载应用。',
    ...
    onboarding_notice_workspace: 'These values are used as defaults for new chats.',
    onboarding_workspace_label: 'Workspace',
    onboarding_workspace_or_path: 'Or choose another local workspace',
    onboarding_workspace_placeholder: '可选：输入本机工作区',
    onboarding_workspace_default: 'Current workspace',
    onboarding_workspace_local: 'Local workspace',
    ...
    onboarding_api_key_help_prefix: '会保存到本机凭据区',
    ...
    onboarding_workspace_help: 'Pick the model to use for new chats after setup completes.',
    ...
    onboarding_notice_password_recommended: 'Optional but recommended on shared devices.',
    ...
    onboarding_finish_help: '完成后会保存设置并进入应用。',
    ...
    onboarding_probe_error_connect_refused: 'Connection refused — confirm the model service is available, then try again.',
    ...
    dismiss: 'Dismiss',
    disable: 'Disable',
    cron_no_jobs: 'No scheduled tasks found.',
    cron_status_off: 'off',
    ...
    cron_attention_desc: 'This recurring scheduled task has no next run time. The scheduler may have failed to compute its next run.',
    cron_attention_croniter_hint: 'The Gateway runtime may be missing the croniter package. Restart the Gateway with cron support, then resume this scheduled task.',
    cron_attention_resume: 'Resume and recalculate',
    cron_jobs_project: 'Scheduled tasks',
    ...
    cron_pause: 'Pause',
    cron_resume: 'Resume',
    cron_job_name_placeholder: 'Scheduled task name',
    ...
    cron_job_created: 'Scheduled task created',
    cron_duplicate: 'Duplicate',
    cron_duplicated: 'Scheduled task duplicated (paused)',
    cron_job_triggered: 'Scheduled task triggered',
    cron_job_paused: 'Scheduled task paused',
    cron_job_resumed: 'Scheduled task resumed',
    cron_job_updated: 'Scheduled task updated',
    cron_delete_confirm_title: 'Delete scheduled task',
    cron_delete_confirm_message: 'This cannot be undone.',
    cron_job_deleted: 'Scheduled task deleted',
    ...
    clear_conversation_artifact_retention: 'Generated images move to recovery and are permanently deleted after 7 days.',
    ...
    tasks_empty_title: 'Select a scheduled task',
    tasks_empty_sub: 'Pick a scheduled task from the task list to view its details and runs, or create a new one.',
    ...
    workspace_use: 'Use',
    workspace_add_path_placeholder: 'Add a local workspace path',
    ...
    workspace_switch_prompt_placeholder: 'Local workspace path',
    ...
    profile_help_card_title: 'Profiles and workspaces',
    profile_help_card_meta: 'Profiles control how the agent works; workspaces control which files it works on.',
    profile_help_concept_title: 'Profiles and workspaces',
    profile_help_concept_heading: 'Profiles decide how; workspaces decide where',
    profile_help_profile_label: 'Profile',
    profile_help_profile_detail: 'Agent identity, memory, skills, model/provider configuration, and connected tools. Create separate profiles when roles such as researcher, writer, marketer, or developer need different context or capabilities.',
    profile_help_workspace_label: 'Workspace',
    profile_help_workspace_detail: 'Project or product folders on disk. Use one workspace per repository or product so chats, terminal commands, and file browsing point to the right files.',
    profile_help_combined_label: 'Use together',
    profile_help_combined_detail: 'A profile can have a default workspace, while each conversation can still switch workspaces. Profiles answer “who is working?”; workspaces answer “where are they working?”',
    ...
    profile_base_url_placeholder: 'Base URL (optional)',
    ...
    cron_schedule_hint: "Use 'every 1h' or a cron expression for recurring scheduled tasks. Bare durations like '30m' run once.",
    cron_schedule_once_warning: "Duration forms like '30m' run once and are removed after running. Use 'every 30m' to keep a recurring scheduled task.",
    ...
    cron_profile_server_default_hint: 'Uses the WebUI server default profile at run time. Existing scheduled tasks without a profile keep this legacy behavior.',
    ...
    approval_skip_all: 'Skip later confirmations in this conversation',
    approval_skip_all_title: 'Stop asking before protected operations in this conversation',
  ...
  it: {
    ...
    offline_network_detail: 'taiji Agent non è raggiungibile da questo browser al momento.',
    offline_autorefresh: 'Aggiornerò automaticamente la pagina quando taiji Agent sarà di nuovo raggiungibile.',
    ...
    mcp_restart_hint: 'Server changes are read-only here. Use administrator configuration and restart the app for changes to take effect.',
    ...
    cmd_skills: 'Elenca le skill taiji Agent disponibili',
  ...
  status_agent_running:'Agente in esecuzione',
    ...
    status_hermes_home: 'Home taiji Agent',
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    session_project_filter_all: 'Tutte',
    session_project_filter_unassigned: 'Non assegnate',
    session_project_filter_unassigned_title: 'Mostra le conversazioni non ancora assegnate a un progetto',
    session_project_filter_empty_unassigned: 'Nessuna conversazione non assegnata.',
    session_project_filter_empty_project: 'Non ci sono ancora conversazioni in questo progetto.',
    ...
    settings_section_preferences_meta: 'Predefiniti e comportamento UI per taiji Agent.',
    ...
    settings_plugins_meta: 'View installed taiji Agent plugins and the lifecycle hooks they register. This panel is read-only.',  // TODO: translate
    settings_plugins_empty: 'No taiji Agent plugins are currently visible. Install or enable plugins from administrator configuration to see them here.',
    ...
    kanban_work_queue_hint: 'Questa è la coda di lavoro di taiji Agent. Crea o classifica un task, assegnalo, spostalo in Pronto, poi lascia che il dispatcher lo reclami.',
    ...
    kanban_assignee_profiles_label: 'Profili taiji Agent',
    ...
    tab_todos: 'Todos',
    tab_insights: 'Insights',
    tab_dashboard: 'Dashboard taiji Agent',
    ...
    settings_desc_sync_insights: 'Rispecchia l\'uso token WebUI su state.db così taiji Agent /insights include i dati delle sessioni browser. Disattivato per impostazione predefinita.',
    ...
    settings_desc_ignore_agent_updates: '保留 WebUI 更新检查，但隐藏 Agent 更新提示，并跳过 Agent 更新拉取。',
    settings_desc_whats_new_summary: '将“更新内容”操作从直接打开原始 diff 改为先生成简短易读的摘要；摘要之后仍可查看常规 diff 对比。',
    ...
    sign_out: 'Esci',
    settings_label_shutdown: 'Arresta il server taiji Agent',
    ...
    settings_shutdown_confirm_title: 'Arresta taiji Agent',
    settings_shutdown_confirm_message: 'Vuoi arrestare il server taiji Agent?',
    ...
    provider_endpoint_label: 'Indirizzo effettivo delle richieste',
    provider_endpoint_source_label: 'Origine indirizzo',
    provider_endpoint_status_label: 'Stato indirizzo',
    provider_endpoint_source_system: 'Sistema',
    provider_endpoint_source_managed: 'Amministratore',
    provider_endpoint_source_custom: 'Personalizzato',
    provider_endpoint_source_runtime: 'Runtime',
    provider_endpoint_source_unknown: 'Sconosciuto',
    provider_endpoint_status_resolved: 'Risolto',
    provider_endpoint_status_runtime_managed: 'Assegnato dal runtime',
    provider_endpoint_status_runtime_unresolved: 'Risolto alla richiesta',
    provider_endpoint_status_missing: 'Non configurato',
    provider_endpoint_status_invalid_saved_value: 'Indirizzo precedente ignorato; inserirne uno nuovo',
    provider_endpoint_status_unknown: 'Sconosciuto',
    provider_endpoint_override_ignored: 'La sovrascrittura precedente è ignorata; salva per pulirla.',
    provider_endpoint_mutation_cleaned: 'La sovrascrittura precedente è stata pulita.',
    provider_endpoint_saved_label: 'Indirizzo usato dopo il salvataggio',
    provider_endpoint_admin_readonly: 'Gestito dalle impostazioni dell’amministratore; modifica non disponibile qui.',
    provider_endpoint_base_url_required: 'Inserisci un Base URL Custom valido.',
    ...
    onboarding_title: 'Benvenuto in taiji Agent',
    onboarding_lead: 'Una configurazione guidata rapida verificherà taiji Agent, salverà una configurazione provider reale, sceglierà un workspace e un modello e opzionalmente proteggerà l\'app con una password.',
    onboarding_back: 'Indietro',
    onboarding_continue: 'Continua',
    onboarding_skip: 'Salta configurazione',
    onboarding_resume: 'Continua i controlli di configurazione',
    onboarding_skipped: 'Configurazione saltata — uso configurazione esistente.',
    onboarding_open: 'Apri taiji Agent',
    onboarding_step_system_title: 'Verifica sistema',
    onboarding_step_system_desc: 'Verifica taiji Agent e visibilità configurazione.',
    onboarding_step_setup_title: 'Configurazione provider',
    onboarding_step_setup_desc: 'Salva la configurazione minima provider taiji Agent.',
    ...
    onboarding_notice_system_ready: 'The local app is ready.',
    onboarding_notice_system_unavailable: 'The local app is still preparing. Finish setup after readiness checks pass.',
    onboarding_check_agent: 'taiji Agent',
    ...
    onboarding_config_file: 'Configuration:',
    onboarding_env_file: 'Credentials:',
    ...
    onboarding_notice_setup_required: 'Choose a provider and save credentials here.',
    onboarding_notice_setup_already_ready: 'Una configurazione provider taiji Agent funzionante è già stata rilevata. Puoi mantenerla o sostituirla qui.',
    onboarding_oauth_provider_ready_title: 'Provider già autenticato',
    onboarding_oauth_provider_ready_body: 'This app is configured to use an OAuth provider (<strong>{provider}</strong>). No API key is needed here — click Continue to finish setup.',
    onboarding_oauth_provider_not_ready_title: 'Provider OAuth non ancora autenticato',
    onboarding_oauth_provider_not_ready_body: 'This app is configured to use <strong>{provider}</strong>, which uses OAuth rather than an API key. Complete administrator authentication, then reload the app.',
    ...
    onboarding_workspace_placeholder: 'Optional local workspace path',
    ...
    onboarding_api_key_help_prefix: 'Saved in the local credentials store',
    ...
    onboarding_workspace_help: 'Scegli il modello che taiji Agent userà per le nuove chat dopo la configurazione.',
    ...
    onboarding_finish_help: 'Finishing saves your setup and opens the app.',
    ...
    clear_conversation_artifact_retention: 'Le immagini generate vengono spostate nel cestino di ripristino e eliminate definitivamente dopo 7 giorni.',
    ...
    profile_help_card_title: 'Profili e spazi di lavoro',
    profile_help_card_meta: 'I profili controllano come lavora l\'agente; gli spazi di lavoro controllano su quali file lavora.',
    profile_help_concept_title: 'Profili e spazi di lavoro',
    profile_help_concept_heading: 'I profili definiscono come; gli spazi di lavoro definiscono dove',
    profile_help_profile_label: 'Profilo',
    profile_help_profile_detail: 'Identità dell\'agente, memoria, competenze, configurazione di modello/provider e strumenti connessi. Crea profili separati quando ruoli come ricercatore, autore, addetto marketing o sviluppatore richiedono contesti o capacità diversi.',
    profile_help_workspace_label: 'Spazio di lavoro',
    profile_help_workspace_detail: 'Cartelle di progetto o prodotto sul disco. Usa uno spazio di lavoro per ogni repository o prodotto, così chat, comandi del terminale e navigazione dei file puntano ai file corretti.',
    profile_help_combined_label: 'Usali insieme',
    profile_help_combined_detail: 'Un profilo può avere uno spazio di lavoro predefinito, mentre ogni conversazione può comunque cambiare spazio di lavoro. I profili rispondono a «chi sta lavorando?»; gli spazi di lavoro rispondono a «dove sta lavorando?»',
  ...
  ja: {
    ...
    offline_network_detail: '現在、このブラウザからtaiji Agentに到達できません。',
    offline_autorefresh: 'taiji Agentに再接続できたら、このページを自動的に更新します。',
    ...
    mic_unavailable: 'マイク入力を利用できません。',
    mic_error: '音声入力エラー: ',
    // MCP / writing / onboarding additions
    mcp_config_title: 'MCP 設定',
    mcp_config_name: '名前',
    mcp_config_preset: 'プリセット',
    mcp_config_custom: 'カスタム stdio',
    mcp_config_command: 'コマンド',
    mcp_config_args: '引数',
    mcp_config_allowed_roots: '許可済みディレクトリ',
    mcp_paste_path: 'パスを貼り付け',
    mcp_choose_directory: 'ディレクトリを選択',
    mcp_path_pasted: 'パスを貼り付けました。',
    mcp_path_empty_clipboard: 'クリップボードにパス文字列がありません。',
    mcp_clipboard_unavailable: 'クリップボードを読み取れません。Cmd/Ctrl+V または右クリックで貼り付けてください。',
    mcp_directory_selected: 'ディレクトリを選択しました。',
    mcp_directory_picker_unavailable: 'ディレクトリ選択はデスクトップアプリで利用できます。ここに絶対パスを貼り付けてください。',
    mcp_directory_picker_failed: 'ディレクトリを選択できませんでした。',
    mcp_save_config: 'MCP 設定を保存',
    mcp_test_connection: '接続をテスト',
    mcp_testing_connection: 'MCP 接続をテスト中…',
    mcp_test_success: (count) => `接続しました。${count} 個のツールが見つかりました。`,
    mcp_test_failed: 'MCP 接続テストに失敗しました。',
    mcp_security_notice: 'Filesystem MCP から利用できるのは許可済みディレクトリのみです。書き込み、削除、上書き、ブラウザーフォーム送信には確認が必要です。',
    mcp_call_logs_title: 'MCP ツール呼び出しログ',
    mcp_call_logs_desc: '引数をマスキングした最近の MCP ツール呼び出しです。',
    mcp_logs_empty: 'MCP ツール呼び出しログはまだありません。',
    mcp_logs_failed: 'MCP ツール呼び出しログを読み込めませんでした。',
    mcp_log_ok: '成功',
    mcp_log_error: 'エラー',
    model_search_clear_title: '検索をクリア',
    model_use_custom_title: 'このモデルを使用',
    cmd_writeflow: '執筆ワークフローを実行',
    writeflow_busy: '執筆ワークフローを実行中です。',
    writeflow_compose_failed: '執筆ワークフローに失敗しました：',
    tab_writing: '執筆',
    onboarding_config_status: '設定：',
    onboarding_config_status_ready: 'ローカル設定の準備ができました',
    onboarding_config_status_pending: 'セットアップを待機中',
    onboarding_credentials_status: '認証情報：',
    onboarding_credentials_status_saved: 'ローカル認証情報を保存しました',
    onboarding_credentials_status_pending: 'プロバイダーの認証情報はまだ保存されていません',
    onboarding_provider_status: 'プロバイダーの状態：',
    onboarding_workspace_default: '現在のワークスペース',
    onboarding_workspace_local: 'ローカルワークスペース',
    // Turn-based voice mode (#1333)
    ...
    cmd_skills: '利用可能な taiji Agent スキルを一覧表示',
  ...
  status_agent_running:'エージェント実行中',
    ...
    status_hermes_home: 'taiji Agent ホーム',
    status_started: '開始',
    status_tokens: 'トークン',
    status_updated: '更新',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    session_project_filter_all: 'すべて',
    session_project_filter_unassigned: '未割り当て',
    session_project_filter_unassigned_title: 'プロジェクトにまだ割り当てられていない会話を表示',
    session_project_filter_empty_unassigned: '未割り当ての会話はありません。',
    session_project_filter_empty_project: 'このプロジェクトにはまだ会話がありません。',
    ...
    settings_section_preferences_meta: 'taiji Agent のデフォルトと UI 動作。',
    ...
    kanban_work_queue_hint: 'これは taiji Agent のワークキューです。タスクを作成またはトリアージし、担当者を割り当て、Ready に移動すると、ディスパッチャーがそれをクレームします。',
    ...
    kanban_assignee_profiles_label: 'taiji Agent プロファイル',
    ...
    tab_todos: 'ToDo',
    tab_insights: 'インサイト',
    tab_dashboard: 'taiji Agent ダッシュボード',
    ...
    settings_desc_sync_insights: 'WebUI のトークン使用量を state.db にミラーし、taiji Agent /insights にブラウザセッションのデータを含めます。デフォルトはオフ。',
    ...
    disable_auth: '認証を無効化',
    sign_out: 'サインアウト',
    settings_label_shutdown: 'taiji Agent サーバーを停止',
    ...
    settings_shutdown_confirm_title: 'taiji Agent を停止',
    settings_shutdown_confirm_message: 'taiji Agent サーバーを停止しますか？',
    ...
    provider_endpoint_label: '実際のモデルリクエスト先',
    provider_endpoint_source_label: 'アドレスの出所',
    provider_endpoint_status_label: 'アドレスの状態',
    provider_endpoint_source_system: 'システム',
    provider_endpoint_source_managed: '管理者設定',
    provider_endpoint_source_custom: 'カスタム',
    provider_endpoint_source_runtime: 'ランタイム',
    provider_endpoint_source_unknown: '不明',
    provider_endpoint_status_resolved: '解決済み',
    provider_endpoint_status_runtime_managed: 'ランタイム割り当て',
    provider_endpoint_status_runtime_unresolved: 'リクエスト時に決定',
    provider_endpoint_status_missing: '未設定',
    provider_endpoint_status_invalid_saved_value: '旧アドレスを無視しました。再入力してください',
    provider_endpoint_status_unknown: '不明',
    provider_endpoint_override_ignored: '旧アドレスの上書きは無視されています。保存して削除してください。',
    provider_endpoint_mutation_cleaned: '旧アドレスの上書きを削除しました。',
    provider_endpoint_saved_label: '保存後に使用するアドレス',
    provider_endpoint_admin_readonly: '管理者設定で管理されています。この画面では編集できません。',
    provider_endpoint_base_url_required: '有効なカスタム Base URL を入力してください。',
    ...
    onboarding_lead: 'クイックガイドで taiji Agent を確認し、プロバイダ設定を保存し、ワークスペースとモデルを選択し、必要ならパスワードでアプリを保護します。',
    onboarding_back: '戻る',
    onboarding_continue: '続ける',
    onboarding_skip: 'セットアップをスキップ',
    onboarding_resume: 'セットアップ確認を続ける',
    onboarding_skipped: 'セットアップをスキップ — 既存設定を使用します。',
    onboarding_open: 'taiji Agent を開く',
    onboarding_step_system_title: 'システム確認',
    onboarding_step_system_desc: 'taiji Agent と設定の可視性を確認します。',
    onboarding_step_setup_title: 'プロバイダ設定',
    onboarding_step_setup_desc: '最低限の taiji Agent プロバイダ設定を保存します。',
    ...
    onboarding_notice_setup_required: 'Choose a provider and save credentials here.',
    onboarding_notice_setup_already_ready: '動作する taiji Agent プロバイダ設定が既に検出されています。維持するか、ここで置き換えできます。',
    ...
    onboarding_workspace_help: 'セットアップ完了後の新規チャットで taiji Agent が使用するモデルを選択してください。',
    onboarding_custom_model_placeholder: 'your-model-name',
    ...
    clear_conversation_artifact_retention: '生成された画像は復元領域に移動し、7 日後に完全に削除されます。',
    clear_failed: 'クリア失敗: ',
    ...
    profile_help_card_title: 'プロファイルとワークスペース',
    profile_help_card_meta: 'プロファイルはエージェントの働き方を制御し、ワークスペースは作業対象のファイルを制御します。',
    profile_help_concept_title: 'プロファイルとワークスペース',
    profile_help_concept_heading: 'プロファイルが「どのように」を、ワークスペースが「どこで」を決めます',
    profile_help_profile_label: 'プロファイル',
    profile_help_profile_detail: 'エージェントのアイデンティティ、メモリ、スキル、モデル／プロバイダー設定、接続済みツール。研究者、ライター、マーケター、開発者などの役割で異なるコンテキストや機能が必要な場合は、個別のプロファイルを作成します。',
    profile_help_workspace_label: 'ワークスペース',
    profile_help_workspace_detail: 'ディスク上のプロジェクトまたは製品フォルダー。リポジトリや製品ごとに1つのワークスペースを使用し、チャット、ターミナルコマンド、ファイル閲覧が正しいファイルを参照するようにします。',
    profile_help_combined_label: '組み合わせて使用',
    profile_help_combined_detail: 'プロファイルには既定のワークスペースを設定できますが、各会話でワークスペースを切り替えることもできます。プロファイルは「誰が作業するか？」に、ワークスペースは「どこで作業するか？」に答えます。',
  ...
  ru: {
    ...
    offline_network_detail: 'taiji Agent сейчас недоступен из этого браузера.',
    offline_autorefresh: 'Я автоматически обновлю страницу, когда taiji Agent снова станет доступен.',
    ...
    mic_unavailable: 'Ввод с микрофона недоступен.',
    mic_error: 'Ошибка ввода речи: ',
    // MCP / writing / onboarding additions
    mcp_config_title: 'Настройка MCP',
    mcp_config_name: 'Название',
    mcp_config_preset: 'Предустановка',
    mcp_config_custom: 'Пользовательский stdio',
    mcp_config_command: 'Команда',
    mcp_config_args: 'Аргументы',
    mcp_config_allowed_roots: 'Разрешённые каталоги',
    mcp_paste_path: 'Вставить путь',
    mcp_choose_directory: 'Выбрать каталог',
    mcp_path_pasted: 'Путь вставлен.',
    mcp_path_empty_clipboard: 'В буфере обмена нет текста с путём.',
    mcp_clipboard_unavailable: 'Не удалось прочитать буфер обмена. Используйте Cmd/Ctrl+V или вставку через контекстное меню.',
    mcp_directory_selected: 'Каталог выбран.',
    mcp_directory_picker_unavailable: 'Выбор каталога доступен в настольном приложении. Вставьте сюда абсолютный путь.',
    mcp_directory_picker_failed: 'Не удалось выбрать каталог.',
    mcp_save_config: 'Сохранить конфигурацию MCP',
    mcp_test_connection: 'Проверить подключение',
    mcp_testing_connection: 'Проверка подключения MCP…',
    mcp_test_success: (count) => `Подключено. Найдено инструментов: ${count}.`,
    mcp_test_failed: 'Проверка подключения MCP завершилась ошибкой.',
    mcp_security_notice: 'Filesystem MCP имеет доступ только к разрешённым каталогам. Запись, удаление, перезапись файлов и отправка браузерных форм требуют подтверждения.',
    mcp_call_logs_title: 'Журнал вызовов инструментов MCP',
    mcp_call_logs_desc: 'Недавние вызовы инструментов MCP со скрытыми аргументами.',
    mcp_logs_empty: 'В журнале пока нет вызовов инструментов MCP.',
    mcp_logs_failed: 'Не удалось загрузить журнал вызовов инструментов MCP.',
    mcp_log_ok: 'Успешно',
    mcp_log_error: 'Ошибка',
    model_search_clear_title: 'Очистить поиск',
    model_use_custom_title: 'Использовать эту модель',
    cmd_writeflow: 'Запустить рабочий процесс написания',
    writeflow_busy: 'Рабочий процесс написания уже выполняется.',
    writeflow_compose_failed: 'Не удалось выполнить рабочий процесс написания: ',
    tab_writing: 'Написание',
    onboarding_config_status: 'Конфигурация:',
    onboarding_config_status_ready: 'Локальная конфигурация готова',
    onboarding_config_status_pending: 'Ожидание настройки',
    onboarding_credentials_status: 'Учётные данные:',
    onboarding_credentials_status_saved: 'Локальные учётные данные сохранены',
    onboarding_credentials_status_pending: 'Учётные данные провайдера ещё не сохранены',
    onboarding_provider_status: 'Состояние провайдера:',
    onboarding_workspace_default: 'Текущее рабочее пространство',
    onboarding_workspace_local: 'Локальное рабочее пространство',
    // Composer voice buttons (#1488)
    ...
    cmd_skills: 'Показать доступные навыки taiji Agent',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    kanban_assignee_profiles_label: 'Профили taiji Agent',
    ...
    tab_dashboard: 'Панель taiji Agent',
    ...
    settings_desc_sync_insights: 'Синхронизирует использование токенов WebUI в state.db, чтобы taiji Agent /insights включал данные браузерных сеансов. Выключено по умолчанию.',
    ...
    sign_out: 'Выйти',
    settings_label_shutdown: 'Остановить сервер taiji Agent',
    ...
    settings_shutdown_confirm_title: 'Остановить taiji Agent',
    settings_shutdown_confirm_message: 'Остановить сервер taiji Agent?',
    ...
    onboarding_lead: 'Краткая пошаговая настройка проверит taiji Agent, сохранит рабочую конфигурацию провайдера, выберет рабочее пространство и модель и при желании защитит приложение паролем.',
    onboarding_back: 'Назад',
    onboarding_continue: 'Продолжить',
    onboarding_skip: 'Пропустить настройку',
    onboarding_resume: 'Продолжить проверку настройки',
    onboarding_skipped: 'Настройка пропущена — используется существующая конфигурация.',
    onboarding_open: 'Открыть taiji Agent',
    onboarding_step_system_title: 'Проверка системы',
    onboarding_step_system_desc: 'Проверить taiji Agent и видимость конфигурации.',
    onboarding_step_setup_title: 'Настройка провайдера',
    onboarding_step_setup_desc: 'Сохранить минимальную рабочую конфигурацию провайдера taiji Agent.',
    ...
    onboarding_notice_setup_required: 'Choose a provider and save credentials here.',
    onboarding_notice_setup_already_ready: 'Уже обнаружена рабочая конфигурация провайдера taiji Agent. Вы можете оставить её или заменить здесь.',
    ...
    onboarding_workspace_help: 'Выберите модель, которую taiji Agent должен использовать для новых чатов после завершения настройки.',
    ...
    clear_conversation_artifact_retention: 'Созданные изображения перемещаются в область восстановления и окончательно удаляются через 7 дней.',
    ...
    profile_help_card_title: 'Профили и рабочие пространства',
    profile_help_card_meta: 'Профили определяют, как работает агент; рабочие пространства определяют, с какими файлами он работает.',
    profile_help_concept_title: 'Профили и рабочие пространства',
    profile_help_concept_heading: 'Профили определяют как, рабочие пространства — где',
    profile_help_profile_label: 'Профиль',
    profile_help_profile_detail: 'Идентичность агента, память, навыки, настройки модели/провайдера и подключённые инструменты. Создавайте отдельные профили, если таким ролям, как исследователь, автор, маркетолог или разработчик, нужны разные контексты или возможности.',
    profile_help_workspace_label: 'Рабочее пространство',
    profile_help_workspace_detail: 'Папки проектов или продуктов на диске. Используйте отдельное рабочее пространство для каждого репозитория или продукта, чтобы чаты, команды терминала и просмотр файлов были связаны с нужными файлами.',
    profile_help_combined_label: 'Использовать вместе',
    profile_help_combined_detail: 'У профиля может быть рабочее пространство по умолчанию, при этом в каждой беседе его всё равно можно переключить. Профили отвечают на вопрос «кто работает?», а рабочие пространства — «где работают?»',
    ...
    session_project_filter_all: 'Все',
    session_project_filter_unassigned: 'Без проекта',
    session_project_filter_unassigned_title: 'Показать беседы, ещё не назначенные проекту',
    session_project_filter_empty_unassigned: 'Нет бесед без проекта.',
    session_project_filter_empty_project: 'В этом проекте пока нет бесед.',
    ...
    settings_desc_voice_mode: 'Показывать кнопку голосового режима (аудиоволны) рядом с микрофоном диктовки. taiji Agent автоматически отправляет реплики после паузы и зачитывает ответы вслух. Требуется браузер с поддержкой распознавания речи и TTS.',
    ...
    checkpoint_diff_files_changed: (n) => `${n} 个文件发生变化`,
  ...
  es: {
    ...
    offline_network_detail: 'taiji Agent no está disponible desde este navegador ahora mismo.',
    offline_autorefresh: 'Actualizaré esta página automáticamente cuando taiji Agent vuelva a estar disponible.',
    ...
    mic_unavailable: 'La entrada de micrófono no está disponible.',
    mic_error: 'Error de entrada por voz: ',
    // MCP / writing / onboarding additions
    mcp_config_title: 'Configuración de MCP',
    mcp_config_name: 'Nombre',
    mcp_config_preset: 'Preajuste',
    mcp_config_custom: 'stdio personalizado',
    mcp_config_command: 'Comando',
    mcp_config_args: 'Argumentos',
    mcp_config_allowed_roots: 'Directorios autorizados',
    mcp_paste_path: 'Pegar ruta',
    mcp_choose_directory: 'Elegir directorio',
    mcp_path_pasted: 'Ruta pegada.',
    mcp_path_empty_clipboard: 'El portapapeles no contiene una ruta.',
    mcp_clipboard_unavailable: 'No se puede leer el portapapeles. Usa Cmd/Ctrl+V o pega con el menú contextual.',
    mcp_directory_selected: 'Directorio seleccionado.',
    mcp_directory_picker_unavailable: 'El selector de directorios está disponible en la aplicación de escritorio. Pega aquí una ruta absoluta.',
    mcp_directory_picker_failed: 'No se pudo elegir el directorio.',
    mcp_save_config: 'Guardar configuración de MCP',
    mcp_test_connection: 'Probar conexión',
    mcp_testing_connection: 'Probando la conexión de MCP…',
    mcp_test_success: (count) => `Conexión establecida. Se encontraron ${count} herramientas.`,
    mcp_test_failed: 'La prueba de conexión de MCP falló.',
    mcp_security_notice: 'Filesystem MCP solo puede acceder a los directorios autorizados. Es necesario confirmar las escrituras, eliminaciones, sobrescrituras y envíos de formularios del navegador.',
    mcp_call_logs_title: 'Registros de llamadas de herramientas MCP',
    mcp_call_logs_desc: 'Llamadas recientes de herramientas MCP con los argumentos ocultos.',
    mcp_logs_empty: 'Todavía no hay registros de llamadas de herramientas MCP.',
    mcp_logs_failed: 'No se pudieron cargar los registros de llamadas de herramientas MCP.',
    mcp_log_ok: 'Correcto',
    mcp_log_error: 'Error',
    model_search_clear_title: 'Borrar búsqueda',
    model_use_custom_title: 'Usar este modelo',
    cmd_writeflow: 'Ejecutar flujo de escritura',
    writeflow_busy: 'El flujo de escritura ya se está ejecutando.',
    writeflow_compose_failed: 'El flujo de escritura falló: ',
    tab_writing: 'Escritura',
    onboarding_config_status: 'Configuración:',
    onboarding_config_status_ready: 'La configuración local está lista',
    onboarding_config_status_pending: 'Esperando la configuración',
    onboarding_credentials_status: 'Credenciales:',
    onboarding_credentials_status_saved: 'Las credenciales locales están guardadas',
    onboarding_credentials_status_pending: 'Aún no se han guardado credenciales del proveedor',
    onboarding_provider_status: 'Estado del proveedor:',
    onboarding_workspace_default: 'Espacio de trabajo actual',
    onboarding_workspace_local: 'Espacio de trabajo local',
    ...
    cmd_skills: 'Listar las skills de taiji Agent disponibles',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    kanban_assignee_profiles_label: 'Perfiles taiji Agent',
    ...
    tab_dashboard: 'Panel de taiji Agent',
    ...
    settings_desc_sync_insights: 'Refleja el uso de tokens de la WebUI en state.db para que taiji Agent /insights incluya datos de sesiones del navegador. Desactivado por defecto.',
    ...
    settings_label_shutdown: 'Detener el servidor taiji Agent',
    ...
    settings_shutdown_confirm_title: 'Detener taiji Agent',
    settings_shutdown_confirm_message: '¿Detener el servidor taiji Agent?',
    ...
    onboarding_title: 'Bienvenido a taiji Agent',
    onboarding_lead: 'Una guía rápida verificará taiji Agent, guardará una configuración real del proveedor, elegirá un espacio de trabajo y un modelo, y opcionalmente protegerá la app con una contraseña.',
    onboarding_back: 'Atrás',
    onboarding_continue: 'Continuar',
    onboarding_skip: 'Omitir configuración',
    onboarding_resume: 'Continuar comprobaciones de configuración',
    onboarding_skipped: 'Configuración omitida — se usa la configuración existente.',
    onboarding_open: 'Abrir taiji Agent',
    onboarding_step_system_title: 'Comprobación del sistema',
    onboarding_step_system_desc: 'Verifica taiji Agent y la visibilidad de la configuración.',
    onboarding_step_setup_title: 'Configuración del proveedor',
    onboarding_step_setup_desc: 'Guarda la configuración mínima real de taiji Agent.',
    ...
    onboarding_notice_setup_required: 'Choose a provider and save credentials here.',
    onboarding_notice_setup_already_ready: 'Ya se detectó una configuración funcional del proveedor de taiji Agent. Puedes conservarla o reemplazarla aquí.',
    ...
    onboarding_workspace_help: 'Elige el modelo que taiji Agent debe usar para nuevos chats cuando termine la configuración.',
    ...
    clear_conversation_title: 'Clear conversation',
    clear_conversation_message: 'Clear all messages? This cannot be undone.',
    clear_conversation_artifact_retention: 'Las imágenes generadas pasan al área de recuperación y se eliminan definitivamente después de 7 días.',
    clear_failed: 'Clear failed: ',
    skills_no_match: 'No skills match.',
    ...
    workspace_switched_to: (name) => `Switched to ${name}`,
    profiles_no_profiles: 'No profiles found.',
    profile_help_card_title: 'Perfiles y espacios de trabajo',
    profile_help_card_meta: 'Los perfiles controlan cómo trabaja el agente; los espacios de trabajo controlan con qué archivos trabaja.',
    profile_help_concept_title: 'Perfiles y espacios de trabajo',
    profile_help_concept_heading: 'Los perfiles deciden cómo; los espacios de trabajo deciden dónde',
    profile_help_profile_label: 'Perfil',
    profile_help_profile_detail: 'Identidad del agente, memoria, habilidades, configuración del modelo/proveedor y herramientas conectadas. Crea perfiles separados cuando roles como investigador, redactor, profesional de marketing o desarrollador necesiten contextos o capacidades diferentes.',
    profile_help_workspace_label: 'Espacio de trabajo',
    profile_help_workspace_detail: 'Carpetas de proyectos o productos en el disco. Usa un espacio de trabajo por repositorio o producto para que los chats, los comandos de terminal y la exploración de archivos apunten a los archivos correctos.',
    profile_help_combined_label: 'Usar juntos',
    profile_help_combined_detail: 'Un perfil puede tener un espacio de trabajo predeterminado y cada conversación puede cambiar de espacio de trabajo. Los perfiles responden «¿quién trabaja?»; los espacios de trabajo responden «¿dónde trabaja?»',
    profile_api_keys_configured: 'API keys configured',
    profile_gateway_running: 'Gateway running',
    profile_gateway_stopped: 'Gateway stopped',
    profile_active: 'ACTIVE',
    ...
    session_project_filter_all: 'Todas',
    session_project_filter_unassigned: 'Sin asignar',
    session_project_filter_unassigned_title: 'Mostrar conversaciones aún no asignadas a un proyecto',
    session_project_filter_empty_unassigned: 'No hay conversaciones sin asignar.',
    session_project_filter_empty_project: 'Aún no hay conversaciones en este proyecto.',
  ...
  de: {
    ...
    offline_network_detail: 'taiji Agent ist von diesem Browser aus gerade nicht erreichbar.',
    offline_autorefresh: 'Ich aktualisiere diese Seite automatisch, sobald taiji Agent wieder erreichbar ist.',
    ...
    cmd_skills: 'Verfügbare taiji Agent-Skills auflisten',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    kanban_assignee_profiles_label: 'taiji Agent-Profile',
    ...
    settings_desc_sync_insights: 'Spiegelt den WebUI-Token-Verbrauch in die state.db, sodass taiji Agent /insights Browser-Sitzungsdaten enthält. Standardmäßig aus.',
    ...
    sign_out: 'Abmelden',
    settings_label_shutdown: 'taiji Agent-Server stoppen',
    ...
    settings_shutdown_confirm_title: 'taiji Agent stoppen',
    settings_shutdown_confirm_message: 'taiji Agent-Server stoppen?',
    ...
    session_project_filter_all: 'Alle',
    session_project_filter_unassigned: 'Nicht zugewiesen',
    session_project_filter_unassigned_title: 'Noch keinem Projekt zugewiesene Unterhaltungen anzeigen',
    session_project_filter_empty_unassigned: 'Keine nicht zugewiesenen Unterhaltungen.',
    session_project_filter_empty_project: 'In diesem Projekt gibt es noch keine Unterhaltungen.',
    ...
    onboarding_title: 'Willkommen bei taiji Agent',
    ...
    onboarding_resume: 'Einrichtungsprüfung fortsetzen',
    onboarding_skipped: 'Einrichtung übersprungen',
    onboarding_open: 'Einrichtung öffnen',
    onboarding_step_system_title: 'Agent-Status',
    onboarding_step_system_desc: 'taiji Agent muss installiert und erreichbar sein.',
    ...
    clear_conversation_artifact_retention: 'Generierte Bilder werden in den Wiederherstellungsbereich verschoben und nach 7 Tagen endgültig gelöscht.',
    ...
    profile_help_card_title: 'Profile und Arbeitsbereiche',
    profile_help_card_meta: 'Profile bestimmen, wie der Agent arbeitet; Arbeitsbereiche bestimmen, mit welchen Dateien er arbeitet.',
    profile_help_concept_title: 'Profile und Arbeitsbereiche',
    profile_help_concept_heading: 'Profile bestimmen das Wie; Arbeitsbereiche bestimmen das Wo',
    profile_help_profile_label: 'Profil',
    profile_help_profile_detail: 'Agentenidentität, Gedächtnis, Fähigkeiten, Modell-/Anbieterkonfiguration und verbundene Werkzeuge. Erstellen Sie separate Profile, wenn Rollen wie Recherche, Redaktion, Marketing oder Entwicklung unterschiedliche Kontexte oder Fähigkeiten benötigen.',
    profile_help_workspace_label: 'Arbeitsbereich',
    profile_help_workspace_detail: 'Projekt- oder Produktordner auf dem Datenträger. Verwenden Sie einen Arbeitsbereich pro Repository oder Produkt, damit Chats, Terminalbefehle und Dateibrowser auf die richtigen Dateien verweisen.',
    profile_help_combined_label: 'Gemeinsam verwenden',
    profile_help_combined_detail: 'Ein Profil kann einen Standardarbeitsbereich haben; jede Unterhaltung kann den Arbeitsbereich dennoch wechseln. Profile beantworten „Wer arbeitet?“, Arbeitsbereiche beantworten „Wo wird gearbeitet?“',
  ...
  zh: {
    offline_title: '连接已断开',
    offline_browser_detail: '此设备当前似乎离线。',
    offline_network_detail: 'taiji Agent 当前不可用。',
    offline_autorefresh: '当 taiji Agent 可用时，我会自动刷新此页面。',
    ...
    cancelling: '正在取消...',
    cancel_failed: '取消失败：',
    mic_denied: '麦克风访问被拒绝，请检查系统权限。',
    mic_no_speech: '没有检测到语音，请再试一次。',
    mic_network: '语音识别当前不可用。',
    mic_unavailable: '当前无法使用麦克风输入。',
    mic_error: '语音输入出错：',
    ...
    mcp_restart_hint: '服务器变更会写入本地智能体配置。重新加载 MCP 工具或重启应用后，运行时清单会刷新。',
    mcp_config_title: 'MCP 配置',
    mcp_config_name: '名称',
    mcp_config_preset: '预设',
    mcp_config_custom: '自定义 stdio',
    mcp_config_command: '命令',
    mcp_config_args: '参数',
    mcp_config_allowed_roots: '授权目录',
    mcp_paste_path: '粘贴路径',
    mcp_choose_directory: '选择目录',
    mcp_path_pasted: '已粘贴路径。',
    mcp_path_empty_clipboard: '剪贴板里没有可用路径。',
    mcp_clipboard_unavailable: '无法读取剪贴板，请使用 Cmd/Ctrl+V 或右键粘贴。',
    mcp_directory_selected: '已选择目录。',
    mcp_directory_picker_unavailable: '目录选择仅在桌面应用中可用；也可以在这里粘贴绝对路径。',
    mcp_directory_picker_failed: '选择目录失败。',
    mcp_save_config: '保存 MCP 配置',
    mcp_test_connection: '测试连接',
    mcp_testing_connection: '正在测试 MCP 连接…',
    mcp_test_success: (count) => `连接成功，发现 ${count} 个工具。`,
    mcp_test_failed: 'MCP 连接测试失败。',
    mcp_security_notice: 'Filesystem MCP 只能访问授权目录；文件写入、删除、覆盖以及网页表单提交等操作需要二次确认。',
    mcp_call_logs_title: 'MCP 工具调用日志',
    mcp_call_logs_desc: '最近的 MCP 工具调用，参数已脱敏。',
    mcp_logs_empty: '暂无 MCP 工具调用日志。',
    mcp_logs_failed: '加载 MCP 工具调用日志失败。',
    mcp_log_ok: '成功',
    mcp_log_error: '错误',
    ...
    mcp_tools_runtime_note: '工具清单仅使用已知的活跃 MCP 运行时数据；应用不会启动或探测服务器。',
    mcp_tools_summary_no_matches: (query,total) => `No MCP tools matching “${query}” (${total} total MCP tools).`,
    mcp_tools_summary_none: 'No MCP tools to show.',
    mcp_tools_summary_matching: (query) => ` matching “${query}”`,
    mcp_tools_summary_total_note: (total) => ` (${total} total MCP tools)`,
    ...
    mcp_tools_page_size_suffix: 'per page',
    mcp_tools_per_page_aria: 'MCP tools per page',
    mcp_tools_inactive_configured_servers: (servers) => `已配置但当前应用运行时未激活：${servers}。`,
    mcp_tools_pagination_label: 'MCP tools pagination',
    mcp_tools_previous_page: '‹ Prev',
    mcp_tools_previous_page_aria: 'Previous MCP tools page',
    mcp_tools_next_page: 'Next ›',
    ...
    approval_summary_generic: '太极智能体需要执行一项受保护操作，才能继续当前任务。',
    approval_summary_pipe_interpreter: '太极智能体需要运行本机脚本，才能继续当前任务。',
    approval_summary_capability: '太极智能体需要开启一项本机能力，才能继续当前任务。',
    approval_summary_delete_files: '太极智能体需要删除本机文件，才能继续当前任务。',
    approval_summary_reset_changes: '太极智能体需要放弃本机尚未保存的修改，才能继续当前任务。',
    approval_summary_overwrite_config: '太极智能体需要修改本机配置文件，才能继续当前任务。',
    approval_summary_elevated_permission: '太极智能体需要使用更高的系统权限，才能继续当前任务。',
    approval_summary_shortened_url: '太极智能体准备打开一个隐藏了真实地址的短链接。',
    approval_summary_homograph_url: '太极智能体检测到一个疑似仿冒正规网站的网址。',
    approval_permission_label: '所需权限',
    approval_permission_local_command: '在本机执行命令',
    approval_impact_label: '允许后',
    approval_impact_continue_task: '系统会执行当前步骤，并继续处理这项任务。',
    approval_impact_capability: '系统会在你选择的范围内开放这项能力。',
    approval_risk_generic: '安全提醒：请确认这与刚才交办的任务一致，再决定是否允许。',
    approval_risk_pipe_interpreter: '安全提醒：检测到内容会直接交给程序执行，请仅在确认内容来源可信时允许。',
    approval_risk_capability: '安全提醒：后续遇到高风险操作时，系统仍会再次询问。',
    approval_view_details: '查看详情',
    approval_details_note: '以下为专业信息，供技术人员排查使用：',
    approval_details_empty: '暂无更多专业信息。',
    approval_rule_label: '安全规则',
    approval_more_options: '更多授权方式',
    approval_confirm_always: '以后遇到同类操作将不再逐次询问。请仅在可信设备上确认。',
    approval_confirm_skip_all: '本次对话之后新出现的受保护操作将不再询问，风险会明显增加；当前操作和已经在等待的其他操作仍需你逐项决定。',
    approval_impact_delete_files: '将删除本机上与当前任务有关的文件。',
    approval_risk_delete_files: '删除后可能无法恢复，请确认这些文件不再需要。',
    approval_impact_reset_changes: '将放弃本机上尚未保存的修改。',
    approval_risk_reset_changes: '未保存的工作内容可能丢失。',
    approval_impact_overwrite_config: '将更改本机上的相关配置文件。',
    approval_risk_overwrite_config: '相关软件之后的运行方式可能发生变化。',
    approval_impact_elevated_permission: '该操作将使用额外的系统权限运行。',
    approval_risk_elevated_permission: '可能影响系统设置或其他用户，请确认后再继续。',
    approval_impact_shortened_url: '该链接可能会跳转到另一个网站。',
    approval_risk_shortened_url: '真实访问地址被隐藏，请仅在信任链接来源时允许。',
    approval_impact_homograph_url: '系统可能会打开一个地址外观相似的网站。',
    approval_risk_homograph_url: '这可能是仿冒或钓鱼网站，请仔细核对网址后再允许。',
    approval_submit_failed: '未能提交，请检查后重试。',
    approval_escape_hint: '按 Esc 可暂不允许',
    approval_confirm_cancel: '返回',
    approval_confirm_continue: '确认继续',
    approval_pending_count: (n) => `第 1 项，共 ${n} 项等待确认`,
    approval_notification_title: '有一项操作需要你确认',
    approval_btn_once: '仅允许这一步',
    approval_btn_once_title: '只允许执行当前这一步',
    approval_btn_session: '本次对话内允许',
    approval_btn_session_title: '本次对话期间允许同类操作',
    approval_btn_always: '长期允许同类操作',
    approval_btn_always_title: '以后遇到同类操作时直接允许',
    approval_btn_deny: '暂不允许',
    approval_btn_deny_title: '不允许执行当前操作',
    ...
    model_search_clear_title: '清空搜索',
    model_use_custom_title: '使用这个模型',
    ...
    cmd_skills: '列出可用的 taiji Agent 技能',
    cmd_writeflow: '运行写作工作流',
    writeflow_busy: '写作工作流正在执行。',
    writeflow_compose_failed: '写作工作流失败：',
    cmd_stop: '停止当前回复',
    ...
    cmd_undo: '移除上一轮问答',
    cmd_btw: '提出一个临时旁路问题',
    cmd_btw_usage: '/btw <问题> — 使用当前会话上下文提出旁路问题',
    cmd_background: '在后台运行一个提示',
    cmd_background_usage: '/background <提示> — 并行运行，不阻塞当前对话',
    btw_asking: '正在询问旁路问题...',
    btw_label: '旁路问题 — 不写入历史',
    btw_done: '旁路问题已回答',
    btw_no_answer: '未收到回答。',
    btw_failed: '旁路问题失败：',
    bg_running: '正在后台运行...',
    ...
    bg_no_answer: '（无回答）',
    bg_failed: '后台任务失败：',
    undo_exchange: '撤销上一轮问答',
    cmd_status: '显示会话信息',
    cmd_voice: '切换麦克风输入',
    stream_stopped: '回复已停止。',
    no_active_task: '没有可停止的活动任务。',
    cancel_unavailable: '当前无法取消。',
    retry_failed: '重试失败：',
    undo_failed: '撤销失败：',
    undid_n_messages: '已移除',
    undid_messages_suffix: '条消息。',
    status_heading: '会话状态',
    ...
    status_messages: '消息数',
    status_agent_running: 'Agent 正在运行',
    status_yes: '是',
    status_no: '否',
    status_load_failed: '加载状态失败：',
    title_current: '当前标题',
    title_change_hint: '使用 `/title <新名称>` 重命名。',
    title_set: '标题已设置为',
    cmd_webui_only_session: '此命令不适用于从 CLI 导入的会话。',
    cmd_voice_use_mic: '请点击输入框中的麦克风按钮。',
    usage_heading: 'Token 用量',
    usage_default_model: '默认',
    usage_unknown: '未知',
    usage_input_tokens: '输入 token',
    usage_output_tokens: '输出 token',
    usage_total: 'Token 总数',
    usage_estimated_cost: '预估费用',
    usage_settings_tip: '注意：费用估算仅供参考。',
    ...
    cmd_goal: '设置或查看持久目标',
    goal_evaluating_progress: '正在评估目标进度…',
    goal_working_toward: '正在推进目标…',
    goal_continuing_toast: '继续推进目标…',
    goal_status_none: '当前没有活动目标。可使用 /goal <文本> 设置。',
    goal_status_active: (turns, max_turns, goal) => `⊙ 目标进行中（${turns}/${max_turns} 轮）：${goal}`,
    goal_status_paused: (turns, max_turns, reason, goal) => `⏸ 目标已暂停（${turns}/${max_turns}${reason ? `，${reason}` : ''}）：${goal}`,
    goal_status_done: (turns, max_turns, goal) => `✓ 目标已完成（${turns}/${max_turns}）：${goal}`,
    goal_set: (turns, goal) => `⊙ 已设置目标（${turns} 轮预算）：${goal}`,
    goal_paused: (goal) => `⏸ 目标已暂停：${goal}`,
    goal_resumed: (goal) => `▶ 目标已恢复：${goal}`,
    goal_cleared: '目标已清除。',
    goal_no_goal: '当前没有活动目标。',
    goal_achieved: (reason) => `✓ 目标已达成：${reason}`,
    goal_paused_budget_exhausted: (turns, max_turns) => `⏸ 目标已暂停 — 已使用 ${turns}/${max_turns} 轮。使用 /goal resume 继续，或 /goal clear 停止。`,
    goal_continuing: (turns, max_turns, reason) => `↻ 继续推进目标（${turns}/${max_turns}）：${reason}`,
    ...
    settings_desc_fade_text_effect: '在助手回复时淡入新流式单词。默认关闭以获得最佳性能。',
    ...
    settings_plugins_meta: '查看已安装的 taiji Agent 插件及其注册的生命周期挂钩。此面板为只读。',
    settings_plugins_empty: 'No taiji Agent plugins are currently visible. Install or enable plugins from administrator configuration to see them here.',
    ...
    session_rename_failed_no_row: '无法开始重命名 — 未找到对应行。',
    renamed_to: '已重命名为 ',
    rename_failed: '重命名失败：',
    delete_title: '删除',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    settings_desc_hide_suggestions: '隐藏空白新聊天页上的三个默认建议按钮，避免误触。',
    ...
    kanban_work_queue_hint: '这是 taiji Agent 的工作队列。创建或分类任务，分配任务，将其移至“就绪”状态，然后让调度员认领任务。',
    ...
    kanban_assignee_profiles_label: 'taiji Agent 配置',
    ...
    tab_todos: '待办',
    tab_insights: '统计',
    tab_dashboard: 'taiji Agent 仪表盘',
    dashboard_loopback_warning: '仪表盘当前不可用。请从桌面应用入口重试，或联系管理员。',
    tab_workspaces: '工作区',
    tab_profiles: '配置',
    tab_logs: '日志',
    tab_settings: '设置',
    ...
    sign_out: '退出登录',
    settings_label_shutdown: '停止 taiji Agent 服务器',
    settings_desc_shutdown: '优雅地停止当前 taiji Agent 应用运行时。再次使用前，请从桌面应用入口重新打开。',
    settings_btn_shutdown: '停止服务器',
    settings_shutdown_confirm_title: '停止 taiji Agent',
    settings_shutdown_confirm_message: '停止 taiji Agent 服务器？',
    settings_shutdown_confirm_btn: '停止',
    settings_shutdown_stopped_message: '应用运行时已停止。你可以关闭此窗口。',
    // Providers panel (English fallback — native translations welcome in follow-up PRs)
    ...
    provider_endpoint_label: '实际模型请求地址',
    provider_endpoint_source_label: '地址来源',
    provider_endpoint_status_label: '地址状态',
    provider_endpoint_source_system: '系统',
    provider_endpoint_source_managed: '管理员配置',
    provider_endpoint_source_custom: '自定义',
    provider_endpoint_source_runtime: '运行时',
    provider_endpoint_source_unknown: '未知',
    provider_endpoint_status_resolved: '已解析',
    provider_endpoint_status_runtime_managed: '运行时分配',
    provider_endpoint_status_runtime_unresolved: '请求时确定',
    provider_endpoint_status_missing: '尚未配置',
    provider_endpoint_status_invalid_saved_value: '已忽略旧地址，请重新录入',
    provider_endpoint_status_unknown: '未知',
    provider_endpoint_override_ignored: '检测到旧版地址覆盖，已停止使用；保存后将清理旧值。',
    provider_endpoint_mutation_cleaned: '旧版地址覆盖已清理。',
    provider_endpoint_saved_label: '保存后将使用的地址',
    provider_endpoint_admin_readonly: '由管理员配置管理，此处不可编辑。',
    provider_endpoint_base_url_required: '请输入有效的自定义 Base URL。',
    ...
    settings_label_notifications: '系统通知',
    ...
    settings_desc_sync_insights: '将 token 使用情况同步到 state.db，使 taiji Agent /insights 包含本机会话数据。默认关闭。',
    settings_desc_check_updates: '当 taiji Agent 有更新版本时显示横幅。会在后台定期执行更新检查。',
    settings_desc_ignore_agent_updates: '保留应用更新检查，但隐藏 Agent 更新提示，并跳过 Agent 更新拉取。',
    settings_desc_whats_new_summary: '将“更新内容”操作从直接打开原始 diff 改为先生成简短易读的摘要；摘要之后仍可查看常规 diff 对比。',
    settings_desc_bot_name: '仅用于默认个人资料。其他个人资料会使用各自的名称。',
    settings_desc_password: '输入新密码以设置或更改。留空保持当前设置。',
    // onboarding
    onboarding_badge: '首次启动',
    onboarding_title: '开始使用前检查',
    archive_extracted: (n, c) => `从 ${c} 个压缩包中解压了 ${n} 个文件`,
    onboarding_lead: '在配置工作台中确认授权、模型、工作区和安全策略，全部就绪后再进入太极 Agent。',
    onboarding_back: '返回',
    onboarding_continue: '继续',
    onboarding_skip: '暂时关闭',
    onboarding_resume: '继续配置·开始使用检查',
    onboarding_skipped: '检查窗口已暂时关闭，未通过前不会标记完成。',
    onboarding_open: '打开太极 Agent',
    onboarding_step_system_title: '就绪检查',
    onboarding_step_system_desc: '查看四项最低门槛。',
    onboarding_step_setup_title: '提供商设置',
    onboarding_step_setup_desc: '保存提供商凭据。',
    onboarding_step_workspace_title: '工作区 + 模型',
    onboarding_step_workspace_desc: '为新会话和聊天选择默认值。',
    onboarding_step_password_title: '可选密码',
    onboarding_step_password_desc: '共享设备使用前可启用密码保护。',
    onboarding_step_finish_title: '完成前复检',
    onboarding_step_finish_desc: '服务端复检通过后进入应用。',
    onboarding_notice_system_ready: '本机应用已就绪。',
    onboarding_notice_system_unavailable: '本机应用仍在准备中。请等待就绪检查通过后再完成设置。',
    onboarding_check_agent: '本机应用',
    onboarding_check_agent_ready: '已就绪',
    onboarding_check_agent_missing: '准备中',
    onboarding_check_password: '密码',
    onboarding_check_password_enabled: '已启用',
    onboarding_check_password_disabled: '尚未启用',
    onboarding_check_provider: '提供商',
    onboarding_check_provider_ready: '可开始聊天',
    onboarding_check_provider_partial: '已保存但不完整',
    onboarding_check_provider_pending: '需要验证',
    onboarding_config_file: '配置状态：',
    onboarding_env_file: '凭据状态：',
    onboarding_config_status: '配置状态：',
    onboarding_config_status_ready: '本机配置已就绪',
    onboarding_config_status_pending: '等待初始化',
    onboarding_credentials_status: '凭据状态：',
    onboarding_credentials_status_saved: '本机凭据已保存',
    onboarding_credentials_status_pending: '尚未保存提供商凭据',
    onboarding_provider_status: '提供商状态：',
    ...
    onboarding_notice_setup_already_ready: '已检测到可用的提供商配置。你可以保留它，或在这里替换。',
    onboarding_oauth_provider_ready_title: '提供商已完成认证',
    onboarding_oauth_provider_ready_body: '当前应用已配置为使用 OAuth 提供商（<strong>{provider}</strong>）。此处无需 API 密钥，请点击“继续”完成设置。',
    onboarding_oauth_provider_not_ready_title: 'OAuth 提供商尚未认证',
    onboarding_oauth_provider_not_ready_body: '当前应用已配置为使用 <strong>{provider}</strong>，该提供商使用 OAuth 而非 API 密钥。请先完成管理员认证，然后重新加载应用。',
    onboarding_oauth_switch_hint: '或者在下方选择其他提供商，切换到 API key 配置：',
    onboarding_notice_workspace: '这些值将作为新对话的默认设置。',
    onboarding_workspace_label: '工作区',
    onboarding_workspace_or_path: '或选择其他本机工作区',
    onboarding_workspace_placeholder: '可选的本地工作区路径',
    onboarding_workspace_default: '当前工作区',
    onboarding_workspace_local: '本机工作区',
    ...
    onboarding_probe_error_dns: '无法解析主机名。请检查模型服务配置后重试。',
    onboarding_probe_error_connect_refused: '连接被拒绝 — 请确认模型服务可用后重试。',
    ...
    clear_conversation_artifact_retention: '生成的图片将进入回收区，7 天后永久删除。',
    clear_failed: '清空失败：',
    ...
    external_notes_configured_hint: '此已配置来源应提供工具名称；当应用运行时提供实时 schema 后会显示在这里。',
    external_notes_recent_ai: 'AI 最近使用',
    external_notes_auto: '自动',
    ...
    profile_help_card_title: '配置与工作区',
    profile_help_card_meta: '配置决定智能体怎么工作；工作区决定它处理哪些文件。',
    profile_help_concept_title: '配置与工作区',
    profile_help_concept_heading: '配置决定怎么做，工作区决定在哪里做',
    profile_help_profile_label: '配置',
    profile_help_profile_detail: 'Agent 身份、记忆、技能、模型/提供商配置和已连接工具。研究员、写作者、市场人员或开发者等角色需要不同上下文或能力时，可以创建独立配置。',
    profile_help_workspace_label: '工作区',
    profile_help_workspace_detail: '磁盘上的项目或产品文件夹。建议每个仓库或产品使用一个工作区，使聊天、终端和文件浏览都指向正确文件。',
    profile_help_combined_label: '组合使用',
    profile_help_combined_detail: '配置可以有默认工作区，但会话中仍可切换工作区。配置回答“谁在工作？”，工作区回答“在哪里工作？”。',
    ...
    profile_base_url_placeholder: 'Base URL（可选）',
    ...
    cron_profile_server_default_hint: '运行时使用应用默认配置档。没有配置档的现有作业会保留此旧行为。',
    ...
    session_hide_external_desc: '从应用列表中隐藏此导入的会话，不删除原始历史记录。',
    ...
    session_delete_worktree_desc: '仅删除应用会话；保留磁盘上的 worktree',
    ...
    session_worktree_remove_desc: (label) => `删除标识为 ${label} 的 git worktree`,
    session_worktree_remove_confirm: (label) => `确定从磁盘删除 git worktree？\n\nWorktree 标识：${label}\n\n整个 worktree 目录将被删除，应用中的会话数据保留。`,
    session_worktree_remove_not_exists: (label) => `标识为 ${label} 的 worktree 在磁盘上已不存在。`,
    ...
    session_project_filter_all: '全部',
    session_project_filter_unassigned: '未分配',
    session_project_filter_unassigned_title: '显示尚未分配到项目的会话',
    session_project_filter_empty_unassigned: '没有未分配的会话。',
    session_project_filter_empty_project: '此项目中还没有会话。',
    ...
    settings_section_preferences_meta: 'taiji Agent 的默认和 UI 行为。',
    ...
    status_profile: '配置文件',
    status_hermes_home: 'taiji Agent 主目录',
    status_started: '开始时间',
    status_tokens: '令牌',
    status_unknown: '未知',
    cmd_yolo: 'YOLO 模式切换',
    ...
    approval_skip_all: '本次对话跳过后续确认',
    approval_skip_all_title: '本次对话后续的受保护操作不再询问',
    // composer action tooltips
    composer_send: '发送消息',
    ...
    settings_desc_voice_mode: '在听写麦克风旁显示语音模式按钮（音频波形）。让您自然说话 — taiji Agent 会在停顿后自动发送并朗读回复。需要当前环境支持语音识别和 TTS。',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    session_worktree_remove_desc: (label) => `刪除標識為 ${label} 的 git worktree`,
    session_worktree_remove_confirm: (label) => `確定從磁碟刪除 git worktree？\n\nWorktree 標識：${label}\n\n整個 worktree 目錄將被刪除，WebUI 中的工作階段資料保留。`,
    session_worktree_remove_not_exists: (label) => `標識為 ${label} 的 worktree 在磁碟上已不存在。`,
    ...
    session_project_filter_all: '全部',
    session_project_filter_unassigned: '未指派',
    session_project_filter_unassigned_title: '顯示尚未指派到專案的會話',
    session_project_filter_empty_unassigned: '沒有未指派的會話。',
    session_project_filter_empty_project: '此專案中尚無會話。',
    ...
    settings_section_preferences_meta: 'taiji Agent 的預設值與介面行為。',
    ...
    settings_plugins_meta: '檢視已安裝的 taiji Agent 外掛及其註冊的生命週期鉤子。此面板為唯讀。',
    settings_plugins_empty: 'No taiji Agent plugins are currently visible. Install or enable plugins from administrator configuration to see them here.',
    ...
    kanban_work_queue_hint: '這是 taiji Agent 的工作佇列。建立或分類任務、指派對象、移至 Ready，然後讓調度器認領。',
    ...
    kanban_assignee_profiles_label: 'taiji Agent 設定檔',
    ...
    sign_out: '\u767b\u51fa',
    settings_label_shutdown: '\u505c\u6b62 taiji Agent \u4f3a\u670d\u5668',
    ...
    settings_shutdown_confirm_title: '\u505c\u6b62 taiji Agent',
    settings_shutdown_confirm_message: '\u505c\u6b62 taiji Agent \u4f3a\u670d\u5668\uff1f',
    settings_shutdown_confirm_btn: '\u505c\u6b62',
    ...
    settings_desc_sync_insights: '將 WebUI token 使用情況同步到 state.db，使 taiji Agent /insights 包含瀏覽器會話數據。預設未啟用。',
    ...
    onboarding_finish_help: 'Finishing saves your setup and opens the app.',
    onboarding_lead: '\u5feb\u901f\u9010\u6b65\u8a2d\u5b9a\uff1a\u6aa2\u67e5 taiji Agent\u3001\u5132\u5b58\u63d0\u4f9b\u8005\u914d\u7f6e\u3001\u9078\u64c7\u5de5\u4f5c\u5340\u8207\u6a21\u578b\uff0c\u4e26\u53ef\u9078\u64c7\u52a0\u5165\u5bc6\u78bc\u4fdd\u8b77\u3002',
    ...
    onboarding_notice_setup_already_ready: '\u5df2\u5075\u6e2c\u5230\u53ef\u7528\u7684 taiji Agent \u63d0\u4f9b\u8005\u914d\u7f6e\u3002\u60a8\u53ef\u4ee5\u4fdd\u7559\u6216\u5728\u6b64\u53d6\u4ee3\u3002',
    onboarding_notice_setup_required: 'Choose a provider and save credentials here.',
    onboarding_notice_system_ready: 'The local app is ready.',
    onboarding_notice_system_unavailable: 'The local app is still preparing. Finish setup after readiness checks pass.',
    ...
    onboarding_open: '\u958b\u555f taiji Agent',
    ...
    onboarding_step_setup_desc: '\u5132\u5b58\u6700\u5c0f\u53ef\u7528\u7684 taiji Agent \u63d0\u4f9b\u8005\u914d\u7f6e\u3002',
    onboarding_step_setup_title: '\u63d0\u4f9b\u8005\u8a2d\u5b9a',
    onboarding_step_system_desc: '\u9a57\u8b49 taiji Agent \u8207\u914d\u7f6e\u53ef\u898b\u6027\u3002',
    onboarding_step_system_title: '\u7cfb\u7d71\u6aa2\u67e5',
    onboarding_step_workspace_desc: '\u70ba\u65b0\u6703\u8a71\u9078\u64c7\u9810\u8a2d\u503c\u3002',
    onboarding_step_workspace_title: '\u5de5\u4f5c\u5340\u8207\u6a21\u578b',
    onboarding_title: '\u6b61\u8fce\u4f7f\u7528 taiji Agent',
    onboarding_unknown: '\u672a\u77e5',
    onboarding_workspace_help: '\u9078\u64c7 taiji Agent \u5728\u8a2d\u5b9a\u5b8c\u6210\u5f8c\u7528\u65bc\u65b0\u804a\u5929\u5ba4\u7684\u6a21\u578b\u3002',
    ...
    clear_conversation_artifact_retention: '\u5df2\u7522\u751f\u7684\u5716\u7247\u5c07\u79fb\u81f3\u5fa9\u539f\u5340\uff0c7 \u5929\u5f8c\u6c38\u4e45\u522a\u9664\u3002',
    clear_failed: '\u6e05\u9664\u5931\u6557\uff1a',
    ...
    profile_help_card_title: '設定檔與工作區',
    profile_help_card_meta: '設定檔決定智慧代理如何工作；工作區決定它處理哪些檔案。',
    profile_help_concept_title: '設定檔與工作區',
    profile_help_concept_heading: '設定檔決定怎麼做，工作區決定在哪裡做',
    profile_help_profile_label: '設定檔',
    profile_help_profile_detail: 'Agent 身分、記憶、技能、模型／提供者設定與已連接工具。研究員、寫作者、行銷人員或開發者等角色需要不同脈絡或能力時，可建立獨立設定檔。',
    profile_help_workspace_label: '工作區',
    profile_help_workspace_detail: '磁碟上的專案或產品資料夾。建議每個儲存庫或產品使用一個工作區，讓會話、終端機與檔案瀏覽都指向正確檔案。',
    profile_help_combined_label: '搭配使用',
    profile_help_combined_detail: '設定檔可以有預設工作區，但每個會話仍可切換工作區。設定檔回答「誰在工作？」，工作區回答「在哪裡工作？」。',
    remove: '\u79fb\u9664',
    remove_failed: '\u79fb\u9664\u5931\u6557\uff1a',
    ...
    status_profile: '個人資料',
    status_hermes_home: 'taiji Agent 主目錄',
    status_started: '開始時間',
    status_tokens: 'Token',
    status_updated: '已更新',
  ...
  pt: {
    ...
    offline_network_detail: 'O taiji Agent está inacessível neste navegador agora.',
    offline_autorefresh: 'Vou atualizar esta página automaticamente quando o taiji Agent voltar a responder.',
    ...
    cmd_skills: 'Listar skills disponíveis do taiji Agent',
    ...
    status_hermes_home: 'Diretório taiji Agent',
    ...
    session_project_filter_all: 'Todas',
    session_project_filter_unassigned: 'Não atribuídas',
    session_project_filter_unassigned_title: 'Mostrar conversas ainda não atribuídas a um projeto',
    session_project_filter_empty_unassigned: 'Não há conversas não atribuídas.',
    session_project_filter_empty_project: 'Ainda não há conversas neste projeto.',
    ...
    settings_section_preferences_meta: 'Padrões e comportamento UI do taiji Agent.',
    settings_section_system_title: 'Sistema',
    ...
    kanban_assignee_profiles_label: 'Perfis taiji Agent',
    ...
    tab_dashboard: 'Painel taiji Agent',
    ...
    sign_out: 'Sair',
    settings_label_shutdown: 'Parar o servidor taiji Agent',
    ...
    settings_shutdown_confirm_title: 'Parar taiji Agent',
    settings_shutdown_confirm_message: 'Parar o servidor taiji Agent?',
    ...
    onboarding_title: 'Bem-vindo ao taiji Agent',
    onboarding_lead: 'Uma configuração rápida vai verificar taiji Agent, salvar provedor, escolher workspace e modelo, e opcionalmente proteger com senha.',
    onboarding_back: 'Voltar',
    onboarding_continue: 'Continuar',
    onboarding_skip: 'Pular configuração',
    onboarding_resume: 'Continuar verificações de configuração',
    onboarding_skipped: 'Configuração pulada — usando config existente.',
    onboarding_open: 'Abrir taiji Agent',
    onboarding_step_system_title: 'Verificação do sistema',
    onboarding_step_system_desc: 'Verificar taiji Agent e visibilidade da config.',
    onboarding_step_setup_title: 'Configuração do provedor',
    onboarding_step_setup_desc: 'Salvar config mínima do provedor taiji Agent.',
    ...
    onboarding_notice_setup_required: 'Choose a provider and save credentials here.',
    onboarding_notice_setup_already_ready: 'Setup de provedor taiji Agent já detectado. Pode manter ou substituir.',
    ...
    onboarding_workspace_help: 'Escolha modelo que taiji Agent deve usar para novos chats.',
    ...
    clear_conversation_artifact_retention: 'As imagens geradas vão para a área de recuperação e são excluídas permanentemente após 7 dias.',
    ...
    profile_help_card_title: 'Perfis e espaços de trabalho',
    profile_help_card_meta: 'Os perfis controlam como o agente trabalha; os espaços de trabalho controlam quais arquivos ele usa.',
    profile_help_concept_title: 'Perfis e espaços de trabalho',
    profile_help_concept_heading: 'Os perfis definem como; os espaços de trabalho definem onde',
    profile_help_profile_label: 'Perfil',
    profile_help_profile_detail: 'Identidade do agente, memória, habilidades, configuração de modelo/provedor e ferramentas conectadas. Crie perfis separados quando funções como pesquisador, redator, profissional de marketing ou desenvolvedor precisarem de contextos ou capacidades diferentes.',
    profile_help_workspace_label: 'Espaço de trabalho',
    profile_help_workspace_detail: 'Pastas de projetos ou produtos no disco. Use um espaço de trabalho por repositório ou produto para que chats, comandos do terminal e navegação de arquivos apontem para os arquivos corretos.',
    profile_help_combined_label: 'Usar em conjunto',
    profile_help_combined_detail: 'Um perfil pode ter um espaço de trabalho padrão, e cada conversa ainda pode trocar de espaço de trabalho. Os perfis respondem “quem está trabalhando?”; os espaços de trabalho respondem “onde estão trabalhando?”',
  ...
  ko: {
    ...
    offline_network_detail: '현재 이 브라우저에서 taiji Agent에 연결할 수 없습니다.',
    offline_autorefresh: 'taiji Agent에 다시 연결되면 이 페이지를 자동으로 새로고침합니다.',
    ...
    mic_unavailable: '마이크 입력을 사용할 수 없습니다.',
    mic_error: '음성 입력 오류: ',
    // MCP / writing / onboarding additions
    mcp_config_title: 'MCP 구성',
    mcp_config_name: '이름',
    mcp_config_preset: '프리셋',
    mcp_config_custom: '사용자 지정 stdio',
    mcp_config_command: '명령',
    mcp_config_args: '인수',
    mcp_config_allowed_roots: '허용된 디렉터리',
    mcp_paste_path: '경로 붙여넣기',
    mcp_choose_directory: '디렉터리 선택',
    mcp_path_pasted: '경로를 붙여넣었습니다.',
    mcp_path_empty_clipboard: '클립보드에 경로 텍스트가 없습니다.',
    mcp_clipboard_unavailable: '클립보드를 읽을 수 없습니다. Cmd/Ctrl+V 또는 마우스 오른쪽 버튼으로 붙여넣으세요.',
    mcp_directory_selected: '디렉터리를 선택했습니다.',
    mcp_directory_picker_unavailable: '디렉터리 선택기는 데스크톱 앱에서 사용할 수 있습니다. 여기에 절대 경로를 붙여넣으세요.',
    mcp_directory_picker_failed: '디렉터리를 선택하지 못했습니다.',
    mcp_save_config: 'MCP 구성 저장',
    mcp_test_connection: '연결 테스트',
    mcp_testing_connection: 'MCP 연결 테스트 중…',
    mcp_test_success: (count) => `연결되었습니다. 도구 ${count}개를 찾았습니다.`,
    mcp_test_failed: 'MCP 연결 테스트에 실패했습니다.',
    mcp_security_notice: 'Filesystem MCP에서는 허용된 디렉터리만 사용할 수 있습니다. 파일 쓰기, 삭제, 덮어쓰기 및 브라우저 양식 제출에는 확인이 필요합니다.',
    mcp_call_logs_title: 'MCP 도구 호출 로그',
    mcp_call_logs_desc: '인수가 가려진 최근 MCP 도구 호출입니다.',
    mcp_logs_empty: '아직 MCP 도구 호출 로그가 없습니다.',
    mcp_logs_failed: 'MCP 도구 호출 로그를 불러오지 못했습니다.',
    mcp_log_ok: '성공',
    mcp_log_error: '오류',
    model_search_clear_title: '검색 지우기',
    model_use_custom_title: '이 모델 사용',
    cmd_writeflow: '쓰기 워크플로 실행',
    writeflow_busy: '쓰기 워크플로가 이미 실행 중입니다.',
    writeflow_compose_failed: '쓰기 워크플로 실패: ',
    tab_writing: '쓰기',
    onboarding_config_status: '구성:',
    onboarding_config_status_ready: '로컬 구성이 준비되었습니다',
    onboarding_config_status_pending: '설정 대기 중',
    onboarding_credentials_status: '자격 증명:',
    onboarding_credentials_status_saved: '로컬 자격 증명이 저장되었습니다',
    onboarding_credentials_status_pending: '아직 제공업체 자격 증명이 저장되지 않았습니다',
    onboarding_provider_status: '제공업체 상태:',
    onboarding_workspace_default: '현재 작업 공간',
    onboarding_workspace_local: '로컬 작업 공간',
    ...
    status_profile: '프로필',
    status_hermes_home: 'taiji Agent 홈',
    ...
    session_project_filter_all: '전체',
    session_project_filter_unassigned: '미할당',
    session_project_filter_unassigned_title: '아직 프로젝트에 할당되지 않은 대화 표시',
    session_project_filter_empty_unassigned: '미할당 대화가 없습니다.',
    session_project_filter_empty_project: '이 프로젝트에는 아직 대화가 없습니다.',
    ...
    settings_section_preferences_meta: 'taiji Agent의 기본값과 UI 동작.',
    ...
    kanban_assignee_profiles_label: 'taiji Agent 프로필',
    ...
    tab_todos: 'Todos',
    tab_insights: '통계',
    tab_dashboard: 'taiji Agent 대시보드',
    ...
    sign_out: '로그아웃',
    settings_label_shutdown: 'taiji Agent 서버 중지',
    ...
    settings_shutdown_confirm_title: 'taiji Agent 중지',
    settings_shutdown_confirm_message: 'taiji Agent 서버를 중지할까요?',
    ...
    onboarding_lead: '간단한 안내 설정으로 taiji Agent 설치를 확인하고, 워크스페이스와 모델을 선택하며, 필요하면 비밀번호로 앱을 보호합니다.',
    onboarding_back: '뒤로',
    onboarding_continue: '계속',
    onboarding_skip: '설정 건너뛰기',
    onboarding_resume: '설정 확인 계속하기',
    onboarding_skipped: 'Setup skipped — using existing config.',
    onboarding_open: 'Open taiji Agent',
    onboarding_step_system_title: 'System check',
    onboarding_step_system_desc: 'Verify taiji Agent and config visibility.',
    onboarding_step_setup_title: 'Provider setup',
    onboarding_step_setup_desc: 'Save the minimum taiji Agent provider config.',
    onboarding_step_workspace_title: 'Workspace + model',
    onboarding_step_workspace_desc: 'Pick defaults for new sessions and chat.',
    onboarding_step_password_title: 'Optional password',
    onboarding_step_password_desc: 'Protect the app before sharing it.',
    ...
    onboarding_missing_imports: 'Missing imports:',
    onboarding_notice_setup_required: 'Choose a provider and save credentials here.',
    onboarding_notice_setup_already_ready: 'A working taiji Agent provider setup is already detected. You can keep it or replace it here.',
    onboarding_oauth_provider_ready_title: 'Provider already authenticated',
    onboarding_oauth_provider_ready_body: 'This app is configured to use an OAuth provider (<strong>{provider}</strong>). No API key is needed here — click Continue to finish setup.',
    onboarding_oauth_provider_not_ready_title: 'OAuth provider not yet authenticated',
    onboarding_oauth_provider_not_ready_body: 'This app is configured to use <strong>{provider}</strong>, which uses OAuth rather than an API key. Complete administrator authentication, then reload the app.',
    ...
    onboarding_base_url_help: 'Use this for OpenAI-compatible routers, self-hosted servers, LiteLLM, Ollama, LM Studio, vLLM, or similar endpoints.',
    onboarding_model_label: 'Default model',
    onboarding_workspace_help: 'Pick the model taiji Agent should use for new chats after setup completes.',
    onboarding_custom_model_placeholder: 'your-model-name',
    onboarding_custom_model_help: 'For custom endpoints, enter the exact model ID your server expects.',
    onboarding_notice_password_enabled: 'A password is already configured. Enter a new one only if you want to replace it.',
    ...
    clear_conversation_title: 'Clear conversation',
    clear_conversation_message: 'Clear all messages? This cannot be undone.',
    clear_conversation_artifact_retention: '생성된 이미지는 복구 영역으로 이동하고 7일 후 영구적으로 삭제됩니다.',
    clear_failed: 'Clear failed: ',
    skills_no_match: 'No skills match.',
    skill_enabled: '활성화됨',
    ...
    workspace_switched_to: (name) => `Switched to ${name}`,
    profiles_no_profiles: 'No profiles found.',
    profile_help_card_title: '프로필 및 워크스페이스',
    profile_help_card_meta: '프로필은 에이전트의 작업 방식을 제어하고, 워크스페이스는 작업할 파일을 제어합니다.',
    profile_help_concept_title: '프로필 및 워크스페이스',
    profile_help_concept_heading: '프로필은 작업 방식을, 워크스페이스는 작업 위치를 결정합니다',
    profile_help_profile_label: '프로필',
    profile_help_profile_detail: '에이전트 정체성, 메모리, 스킬, 모델/제공자 구성 및 연결된 도구입니다. 연구자, 작성자, 마케터 또는 개발자 같은 역할에 서로 다른 컨텍스트나 기능이 필요하면 별도의 프로필을 만드세요.',
    profile_help_workspace_label: '워크스페이스',
    profile_help_workspace_detail: '디스크의 프로젝트 또는 제품 폴더입니다. 저장소나 제품마다 하나의 워크스페이스를 사용하여 채팅, 터미널 명령 및 파일 탐색이 올바른 파일을 가리키도록 하세요.',
    profile_help_combined_label: '함께 사용',
    profile_help_combined_detail: '프로필에는 기본 워크스페이스를 설정할 수 있으며, 각 대화에서 워크스페이스를 전환할 수도 있습니다. 프로필은 “누가 작업하는가?”에, 워크스페이스는 “어디에서 작업하는가?”에 답합니다.',
    profile_api_keys_configured: 'API keys configured',
    profile_gateway_running: 'Gateway running',
    profile_gateway_stopped: 'Gateway stopped',
    profile_active: 'ACTIVE',
  ...
  fr: {
    ...
    offline_network_detail: 'taiji Agent est actuellement inaccessible depuis ce navigateur.',
    offline_autorefresh: 'J\'actualiserai automatiquement cette page lorsqu\'taiji Agent sera à nouveau joignable.',
    ...
    cmd_skills: 'Lister les compétences taiji Agent disponibles',
    ...
    status_hermes_home: 'Maison taiji Agent',
    ...
    session_project_filter_all: 'Toutes',
    session_project_filter_unassigned: 'Non attribuées',
    session_project_filter_unassigned_title: 'Afficher les conversations qui ne sont pas encore attribuées à un projet',
    session_project_filter_empty_unassigned: 'Aucune conversation non attribuée.',
    session_project_filter_empty_project: 'Aucune conversation dans ce projet pour le moment.',
    ...
    settings_section_preferences_meta: 'Paramètres par défaut et comportement de l\'interface utilisateur pour taiji Agent.',
    ...
    kanban_work_queue_hint: 'Il s\'agit de la file d\'attente de travail de l\'agent taiji Agent. Créez ou triez une tâche, attribuez-la, déplacez-la vers Prêt, puis laissez le répartiteur la réclamer.',
    ...
    kanban_assignee_profiles_label: 'Profils taiji Agent',
    ...
    tab_dashboard: 'Tableau de bord taiji Agent',
    ...
    settings_desc_sync_insights: 'Met en miroir l\'utilisation du jeton WebUI dans state.db afin que taiji Agent /insights inclut les données de session du navigateur. Désactivé par défaut.',
    ...
    settings_label_shutdown: 'Arrêter le serveur taiji Agent',
    ...
    settings_shutdown_confirm_title: 'Arrêter taiji Agent',
    settings_shutdown_confirm_message: 'Arrêter le serveur taiji Agent ?',
    ...
    onboarding_title: 'Bienvenue dans l\'interface utilisateur Web taiji Agent',
    onboarding_lead: 'Une configuration guidée rapide vérifiera taiji Agent, enregistrera une configuration réelle du fournisseur, choisira un espace de travail et un modèle et protégera éventuellement l\'application avec un mot de passe.',
    onboarding_back: 'Dos',
    onboarding_continue: 'Continuer',
    onboarding_skip: 'Ignorer la configuration',
    onboarding_resume: 'Continuer les vérifications de configuration',
    onboarding_skipped: 'Configuration ignorée – en utilisant la configuration existante.',
    onboarding_open: 'taiji Agent ouvert',
    onboarding_step_system_title: 'Vérification du système',
    onboarding_step_system_desc: 'Vérifiez la visibilité de l\'agent taiji Agent et de la configuration.',
    onboarding_step_setup_title: 'Configuration du fournisseur',
    onboarding_step_setup_desc: 'Enregistrez la configuration minimale du fournisseur taiji Agent.',
    ...
    onboarding_notice_system_ready: 'The local app is ready.',
    onboarding_notice_system_unavailable: 'The local app is still preparing. Finish setup after readiness checks pass.',
    onboarding_check_agent: 'Agent taiji Agent',
    ...
    onboarding_notice_setup_required: 'Choose a provider and save credentials here.',
    onboarding_notice_setup_already_ready: 'Une configuration de fournisseur taiji Agent fonctionnelle est déjà détectée. Vous pouvez le conserver ou le remplacer ici.',
    ...
    onboarding_workspace_help: 'Choisissez le modèle qu\'taiji Agent doit utiliser pour les nouvelles discussions une fois la configuration terminée.',
    ...
    clear_conversation_artifact_retention: 'Les images générées sont placées dans la zone de récupération, puis supprimées définitivement après 7 jours.',
    ...
    profile_help_card_title: 'Profils et espaces de travail',
    profile_help_card_meta: 'Les profils déterminent comment l\'agent travaille ; les espaces de travail déterminent les fichiers sur lesquels il travaille.',
    profile_help_concept_title: 'Profils et espaces de travail',
    profile_help_concept_heading: 'Les profils déterminent comment ; les espaces de travail déterminent où',
    profile_help_profile_label: 'Profil',
    profile_help_profile_detail: 'Identité de l\'agent, mémoire, compétences, configuration du modèle/fournisseur et outils connectés. Créez des profils distincts lorsque des rôles tels que chercheur, rédacteur, spécialiste marketing ou développeur nécessitent des contextes ou des capacités différents.',
    profile_help_workspace_label: 'Espace de travail',
    profile_help_workspace_detail: 'Dossiers de projet ou de produit sur le disque. Utilisez un espace de travail par dépôt ou produit afin que les discussions, les commandes du terminal et la navigation dans les fichiers ciblent les bons fichiers.',
    profile_help_combined_label: 'Utiliser ensemble',
    profile_help_combined_detail: 'Un profil peut avoir un espace de travail par défaut, tandis que chaque conversation peut toujours changer d\'espace de travail. Les profils répondent à « qui travaille ? » ; les espaces de travail répondent à « où travaillent-ils ? »',
  ...
  tr: {
    ...
    offline_network_detail: 'taiji Agent\'e şu anda bu tarayıcıdan ulaşılamıyor.',
    offline_autorefresh: 'taiji Agent\'e tekrar ulaşılabilir olduğunda bu sayfayı otomatik olarak yenileyeceğim.',
    ...
    mic_unavailable: 'Mikrofon girişi kullanılamıyor.',
    mic_error: 'Ses girişi hatası:',
    // MCP / writing / onboarding additions
    mcp_config_title: 'MCP yapılandırması',
    mcp_config_name: 'Ad',
    mcp_config_preset: 'Ön ayar',
    mcp_config_custom: 'Özel stdio',
    mcp_config_command: 'Komut',
    mcp_config_args: 'Bağımsız değişkenler',
    mcp_config_allowed_roots: 'Yetkili dizinler',
    mcp_paste_path: 'Yolu yapıştır',
    mcp_choose_directory: 'Dizin seç',
    mcp_path_pasted: 'Yol yapıştırıldı.',
    mcp_path_empty_clipboard: 'Panoda yol metni yok.',
    mcp_clipboard_unavailable: 'Pano okunamıyor. Cmd/Ctrl+V veya sağ tıkla yapıştırmayı kullanın.',
    mcp_directory_selected: 'Dizin seçildi.',
    mcp_directory_picker_unavailable: 'Dizin seçici masaüstü uygulamasında kullanılabilir. Buraya mutlak bir yol yapıştırın.',
    mcp_directory_picker_failed: 'Dizin seçilemedi.',
    mcp_save_config: 'MCP yapılandırmasını kaydet',
    mcp_test_connection: 'Bağlantıyı test et',
    mcp_testing_connection: 'MCP bağlantısı test ediliyor…',
    mcp_test_success: (count) => `Bağlandı. ${count} araç bulundu.`,
    mcp_test_failed: 'MCP bağlantı testi başarısız oldu.',
    mcp_security_notice: 'Filesystem MCP yalnızca yetkili dizinlere erişebilir. Dosya yazma, silme, üzerine yazma ve tarayıcı formu gönderme işlemleri onay gerektirir.',
    mcp_call_logs_title: 'MCP araç çağrısı günlükleri',
    mcp_call_logs_desc: 'Bağımsız değişkenleri gizlenmiş son MCP araç çağrıları.',
    mcp_logs_empty: 'Henüz MCP araç çağrısı günlüğü yok.',
    mcp_logs_failed: 'MCP araç çağrısı günlükleri yüklenemedi.',
    mcp_log_ok: 'Başarılı',
    mcp_log_error: 'Hata',
    model_search_clear_title: 'Aramayı temizle',
    model_use_custom_title: 'Bu modeli kullan',
    cmd_writeflow: 'Yazma iş akışını çalıştır',
    writeflow_busy: 'Yazma iş akışı zaten çalışıyor.',
    writeflow_compose_failed: 'Yazma iş akışı başarısız oldu: ',
    tab_writing: 'Yazma',
    onboarding_config_status: 'Yapılandırma:',
    onboarding_config_status_ready: 'Yerel yapılandırma hazır',
    onboarding_config_status_pending: 'Kurulum bekleniyor',
    onboarding_credentials_status: 'Kimlik bilgileri:',
    onboarding_credentials_status_saved: 'Yerel kimlik bilgileri kaydedildi',
    onboarding_credentials_status_pending: 'Henüz sağlayıcı kimlik bilgileri kaydedilmedi',
    onboarding_provider_status: 'Sağlayıcı durumu:',
    onboarding_workspace_default: 'Geçerli çalışma alanı',
    onboarding_workspace_local: 'Yerel çalışma alanı',
    voice_dictate: 'Dikte',
    ...
    cmd_skills: 'Mevcut taiji Agent becerilerini listele',
    ...
    status_profile: 'Profil',
    status_hermes_home: 'taiji Agent\'in evi',
    ...
    session_project_filter_all: 'Tümü',
    session_project_filter_unassigned: 'Atanmamış',
    session_project_filter_unassigned_title: 'Henüz bir projeye atanmamış konuşmaları göster',
    session_project_filter_empty_unassigned: 'Atanmamış konuşma yok.',
    session_project_filter_empty_project: 'Bu projede henüz konuşma yok.',
    ...
    settings_section_preferences_meta: 'taiji Agent Web Kullanıcı Arayüzü için varsayılanlar ve Kullanıcı Arayüzü davranışı.',
    ...
    settings_plugins_meta: 'Yüklü taiji Agent eklentilerini ve yaşam döngüsü kancalarını görüntüleyin. Bu panel salt okunurdur.',
    settings_plugins_empty: 'No taiji Agent plugins are currently visible. Install or enable plugins from administrator configuration to see them here.',
    ...
    kanban_work_queue_hint: 'Bu taiji Agent Ajanının iş kuyruğudur. Bir görev oluşturun veya önceliklendirin, atayın, Hazır\'a taşıyın ve sevk görevlisinin görevi talep etmesine izin verin.',
    ...
    kanban_assignee_profiles_label: 'taiji Agent profilleri',
    ...
    tab_dashboard: 'taiji Agent Kontrol Paneli',
    ...
    settings_label_shutdown: 'taiji Agent sunucusunu durdur',
    ...
    settings_shutdown_confirm_title: 'taiji Agent\'yi durdur',
    settings_shutdown_confirm_message: 'taiji Agent sunucusu durdurulsun mu?',
    ...
    onboarding_lead: 'Hızlı yönlendirmeli kurulum, taiji Agent\'i doğrulayacak, gerçek bir sağlayıcı yapılandırmasını kaydedecek, bir çalışma alanı ve modeli seçecek ve isteğe bağlı olarak uygulamayı bir parola ile koruyacaktır.',
    onboarding_back: 'Geri',
    onboarding_continue: 'Devam etmek',
    onboarding_skip: 'Kurulumu atla',
    onboarding_resume: 'Kurulum denetimlerine devam et',
    onboarding_skipped: 'Kurulum atlandı — mevcut yapılandırma kullanılıyor.',
    onboarding_open: 'taiji Agent\'i aç',
    onboarding_step_system_title: 'Sistem kontrolü',
    onboarding_step_system_desc: 'taiji Agent\'ı ve yapılandırma görünürlüğünü doğrulayın.',
    onboarding_step_setup_title: 'Sağlayıcı kurulumu',
    onboarding_step_setup_desc: 'Minimum taiji Agent sağlayıcı yapılandırmasını kaydedin.',
    ...
    onboarding_notice_system_ready: 'The local app is ready.',
    onboarding_notice_system_unavailable: 'The local app is still preparing. Finish setup after readiness checks pass.',
    onboarding_check_agent: 'taiji Agent Temsilcisi',
    ...
    onboarding_notice_setup_required: 'Choose a provider and save credentials here.',
    onboarding_notice_setup_already_ready: 'Çalışan bir taiji Agent sağlayıcı kurulumu zaten algılandı. Burada saklayabilir veya değiştirebilirsiniz.',
    ...
    onboarding_workspace_help: 'Kurulum tamamlandıktan sonra taiji Agent\'in yeni sohbetler için kullanması gereken modeli seçin.',
    ...
    clear_conversation_artifact_retention: 'Oluşturulan görseller kurtarma alanına taşınır ve 7 gün sonra kalıcı olarak silinir.',
    ...
    profile_help_card_title: 'Profiller ve çalışma alanları',
    profile_help_card_meta: 'Profiller aracının nasıl çalışacağını, çalışma alanları ise hangi dosyalarda çalışacağını belirler.',
    profile_help_concept_title: 'Profiller ve çalışma alanları',
    profile_help_concept_heading: 'Profiller nasıl çalışılacağını, çalışma alanları nerede çalışılacağını belirler',
    profile_help_profile_label: 'Profil',
    profile_help_profile_detail: 'Aracı kimliği, bellek, beceriler, model/sağlayıcı yapılandırması ve bağlı araçlar. Araştırmacı, yazar, pazarlamacı veya geliştirici gibi roller farklı bağlamlara ya da yeteneklere ihtiyaç duyduğunda ayrı profiller oluşturun.',
    profile_help_workspace_label: 'Çalışma alanı',
    profile_help_workspace_detail: 'Diskteki proje veya ürün klasörleri. Sohbetlerin, terminal komutlarının ve dosya taramasının doğru dosyaları göstermesi için her depo veya ürün için bir çalışma alanı kullanın.',
    profile_help_combined_label: 'Birlikte kullan',
    profile_help_combined_detail: 'Bir profilin varsayılan çalışma alanı olabilir; ancak her konuşmada çalışma alanı yine de değiştirilebilir. Profiller “kim çalışıyor?” sorusunu, çalışma alanları ise “nerede çalışılıyor?” sorusunu yanıtlar.',
    ...
    settings_desc_voice_mode: 'Dikte mikrofonunun yanında ses modu düğmesini gösterir. Duraklamadan sonra taiji Agent otomatik gönderir ve yanıtları sesli okur. Konuşma tanıma ve TTS destekleyen tarayıcı gerektirir.',
...
const DEFAULT_LOCALE_KEY = LOCALES.zh ? 'zh' : 'en';

// Active locale — defaults to Simplified Chinese; overridden by loadLocale() at boot.
let _locale = LOCALES[DEFAULT_LOCALE_KEY];
...
function resolvePreferredLocale(primary, fallback) {
  return resolveLocale(primary) || resolveLocale(fallback) || DEFAULT_LOCALE_KEY;
}
...
function setLocale(lang) {
  const resolved = resolveLocale(lang) || DEFAULT_LOCALE_KEY;
...
function applyLocaleToDOM() {
  ...
  document.querySelectorAll('[data-i18n-title]').forEach(el => {
    ...
    if (!el.hasAttribute('data-i18n-aria-label') && el.hasAttribute('aria-label')) {
