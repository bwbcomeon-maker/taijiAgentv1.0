...
#endif
#ifndef PayloadRoot
  #error PayloadRoot must be provided with /DPayloadRoot=D:\candidate\payload
#endif
#ifndef OutputDir
  #error OutputDir must be provided with /DOutputDir=D:\candidate\output
#endif
#ifndef OutputBaseFilename
  #error OutputBaseFilename must be provided with /DOutputBaseFilename=TaijiAgent-Setup-x.y.z-win-x64
#endif
