...
CANDIDATE_CORE_GRAMMAR_ENTRYPOINTS = (
    ...
    ROOT / "packaging/pipeline/adapters/windows_ssh.py",
    ROOT / "packaging/windows/import_product_source.py",
    ROOT / "packaging/windows/builder_input_package.py",
    ROOT / "packaging/windows/safe_tar.py",
    ROOT / "packaging/windows/candidate_evidence.py",
